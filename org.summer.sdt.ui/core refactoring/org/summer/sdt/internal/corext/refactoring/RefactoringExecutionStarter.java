 ...
 *******************************************************************************/
package org.summer.sdt.internal.corext.refactoring;
...
import org.summer.sdt.internal.corext.fix.CleanUpRefactoring;
import org.summer.sdt.internal.corext.refactoring.base.RefactoringStatusCodes;
import org.summer.sdt.internal.corext.refactoring.code.ConvertAnonymousToNestedRefactoring;
import org.summer.sdt.internal.corext.refactoring.code.InlineConstantRefactoring;
import org.summer.sdt.internal.corext.refactoring.code.InlineMethodRefactoring;
import org.summer.sdt.internal.corext.refactoring.code.InlineTempRefactoring;
import org.summer.sdt.internal.corext.refactoring.code.IntroduceFactoryRefactoring;
import org.summer.sdt.internal.corext.refactoring.code.IntroduceIndirectionRefactoring;
import org.summer.sdt.internal.corext.refactoring.code.IntroduceParameterRefactoring;
import org.summer.sdt.internal.corext.refactoring.code.ReplaceInvocationsRefactoring;
import org.summer.sdt.internal.corext.refactoring.generics.InferTypeArgumentsRefactoring;
import org.summer.sdt.internal.corext.refactoring.reorg.JavaCopyProcessor;
...
import org.summer.sdt.internal.corext.refactoring.reorg.ReorgPolicyFactory;
import org.summer.sdt.internal.corext.refactoring.reorg.IReorgPolicy.ICopyPolicy;
import org.summer.sdt.internal.corext.refactoring.reorg.IReorgPolicy.IMovePolicy;
...
import org.summer.sdt.internal.corext.refactoring.structure.ChangeTypeRefactoring;
import org.summer.sdt.internal.corext.refactoring.structure.ExtractClassRefactoring;
import org.summer.sdt.internal.corext.refactoring.structure.ExtractInterfaceProcessor;
import org.summer.sdt.internal.corext.refactoring.structure.ExtractSupertypeProcessor;
import org.summer.sdt.internal.corext.refactoring.structure.IntroduceParameterObjectProcessor;
import org.summer.sdt.internal.corext.refactoring.structure.MoveInnerToTopRefactoring;
import org.summer.sdt.internal.corext.refactoring.structure.MoveInstanceMethodProcessor;
import org.summer.sdt.internal.corext.refactoring.structure.MoveStaticMembersProcessor;
import org.summer.sdt.internal.corext.refactoring.structure.PullUpRefactoringProcessor;
import org.summer.sdt.internal.corext.refactoring.structure.PushDownRefactoringProcessor;
import org.summer.sdt.internal.corext.refactoring.structure.UseSuperTypeProcessor;
import org.summer.sdt.internal.corext.util.Messages;
import org.summer.sdt.internal.ui.actions.ActionMessages;
import org.summer.sdt.internal.ui.fix.CleanUpRefactoringWizard;
import org.summer.sdt.internal.ui.preferences.JavaPreferencesSettings;
import org.summer.sdt.internal.ui.refactoring.ChangeSignatureWizard;
import org.summer.sdt.internal.ui.refactoring.ChangeTypeWizard;
import org.summer.sdt.internal.ui.refactoring.ConvertAnonymousToNestedWizard;
import org.summer.sdt.internal.ui.refactoring.ExtractClassWizard;
import org.summer.sdt.internal.ui.refactoring.ExtractInterfaceWizard;
import org.summer.sdt.internal.ui.refactoring.ExtractSupertypeWizard;
import org.summer.sdt.internal.ui.refactoring.InferTypeArgumentsWizard;
import org.summer.sdt.internal.ui.refactoring.InlineConstantWizard;
import org.summer.sdt.internal.ui.refactoring.InlineTempWizard;
import org.summer.sdt.internal.ui.refactoring.IntroduceFactoryWizard;
import org.summer.sdt.internal.ui.refactoring.IntroduceIndirectionWizard;
import org.summer.sdt.internal.ui.refactoring.IntroduceParameterObjectWizard;
import org.summer.sdt.internal.ui.refactoring.IntroduceParameterWizard;
import org.summer.sdt.internal.ui.refactoring.MoveInnerToTopWizard;
import org.summer.sdt.internal.ui.refactoring.MoveInstanceMethodWizard;
import org.summer.sdt.internal.ui.refactoring.MoveMembersWizard;
import org.summer.sdt.internal.ui.refactoring.PullUpWizard;
import org.summer.sdt.internal.ui.refactoring.PushDownWizard;
import org.summer.sdt.internal.ui.refactoring.RefactoringExecutionHelper;
import org.summer.sdt.internal.ui.refactoring.RefactoringMessages;
import org.summer.sdt.internal.ui.refactoring.UseSupertypeWizard;
import org.summer.sdt.internal.ui.refactoring.actions.RefactoringStarter;
import org.summer.sdt.internal.ui.refactoring.code.InlineMethodWizard;
import org.summer.sdt.internal.ui.refactoring.code.ReplaceInvocationsWizard;
import org.summer.sdt.internal.ui.refactoring.reorg.CreateTargetQueries;
import org.summer.sdt.internal.ui.refactoring.reorg.DeleteUserInterfaceManager;
import org.summer.sdt.internal.ui.refactoring.reorg.NewNameQueries;
import org.summer.sdt.internal.ui.refactoring.reorg.ReorgCopyWizard;
import org.summer.sdt.internal.ui.refactoring.reorg.ReorgMoveWizard;
import org.summer.sdt.internal.ui.refactoring.reorg.ReorgQueries;
import org.summer.sdt.internal.ui.refactoring.sef.SelfEncapsulateFieldWizard;
...
import org.summer.sdt.ui.refactoring.RenameSupport;
