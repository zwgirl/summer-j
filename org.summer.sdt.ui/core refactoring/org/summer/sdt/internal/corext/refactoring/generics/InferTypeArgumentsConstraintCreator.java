...
package org.summer.sdt.internal.corext.refactoring.generics;
...
import org.summer.sdt.internal.corext.refactoring.typeconstraints.types.GenericType;
import org.summer.sdt.internal.corext.refactoring.typeconstraints.types.ParameterizedType;
import org.summer.sdt.internal.corext.refactoring.typeconstraints.types.TType;
import org.summer.sdt.internal.corext.refactoring.typeconstraints.types.TypeVariable;
import org.summer.sdt.internal.corext.refactoring.typeconstraints.types.WildcardType;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ArrayElementVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.CollectionElementVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ConstraintVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ImmutableTypeVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.IndependentTypeVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ParameterTypeVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ParameterizedTypeVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ReturnTypeVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.TTypes;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.TypeVariable2;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.VariableVariable2;
...
public class InferTypeArgumentsConstraintCreator extends HierarchicalASTVisitor {
	 ...
	 */
	private static final String CV_PROP= "org.summer.sdt.internal.corext.refactoring.typeconstraints.CONSTRAINT_VARIABLE"; //$NON-NLS-1$
...
//			fTCModel.createSubtypeConstraint(classTypeVariable, boundType);
		...
		for (int i= 0; i < arguments.size(); i++) {
			...
			if (! methodBinding.isVarargs() || i < lastParamIdx) {
				...
				if (i == lastParamIdx && canAssignToVararg(
						...
						(org.summer.sdt.internal.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType)) {
					//OK: argument will not be packed into an array
				} else {
					declaredParameterType= ((org.summer.sdt.internal.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType).getComponentType();
				}
			}
			...
			if (declaredParameterType.isTypeVariable()) {
				...
				TType declaredElementType= ((org.summer.sdt.internal.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType).getElementType();
	...
	private boolean canAssignToVararg(TType rhs, org.summer.sdt.internal.corext.refactoring.typeconstraints.types.ArrayType lhs) {
