...
import org.summer.sdt.internal.corext.refactoring.reorg.SourceReferenceUtil;
...
public class PullUpRefactoringProcessor extends HierarchyProcessor {
	...
	private static final String IDENTIFIER= "org.summer.sdt.ui.pullUpProcessor"; //$NON-NLS-1$

	/** The pull up group category set */
	private static final GroupCategorySet SET_PULL_UP= new GroupCategorySet(new GroupCategory("org.summer.sdt.internal.corext.pullUp", //$NON-NLS-1$
