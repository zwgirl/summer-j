...
public class CompositeOrTypeConstraint implements ITypeConstraint{
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.corext.refactoring.experiments.ITypeConstraint#toResolvedString()
	 */
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.corext.refactoring.experiments.ITypeConstraint#isSimpleTypeConstraint()
	 */
