...
public final class PushDownRefactoringProcessor extends HierarchyProcessor {
	...
	public static final String IDENTIFIER= "org.summer.sdt.ui.pushDownProcessor"; //$NON-NLS-1$

	/** The push down group category set */
	private static final GroupCategorySet SET_PUSH_DOWN= new GroupCategorySet(new GroupCategory("org.summer.sdt.internal.corext.pushDown", //$NON-NLS-1$
