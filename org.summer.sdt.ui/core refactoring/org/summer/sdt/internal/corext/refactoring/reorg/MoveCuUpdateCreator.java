...
import org.summer.sdt.internal.corext.refactoring.structure.ReferenceFinderUtil;
...
public class MoveCuUpdateCreator {
	...
	private final static class Collector extends CollectingSearchRequestor {
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.corext.refactoring.CollectingSearchRequestor#acceptSearchMatch(SearchMatch)
		 */
		@Override
