...
import org.summer.sdt.internal.corext.refactoring.binary.StubCreator;
...
public class ReplaceInvocationsRefactoring extends Refactoring {
	...
	private static final String ID_REPLACE_INVOCATIONS= "org.summer.sdt.ui.replace.invocations"; //$NON-NLS-1$
	...
	private SourceProvider resolveSourceProvider(IMethodBinding methodBinding, RefactoringStatus status) throws JavaModelException {
		...
		if (methodCu != null) {
			...
			StubCreator stubCreator= new StubCreator(true) {
				...
				/*
				 * @see org.summer.sdt.internal.corext.refactoring.binary.StubCreator#appendMethodParameterName(org.summer.sdt.core.IMethod, int)
				 */
				@Override
