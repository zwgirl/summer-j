...
import org.summer.sdt.core.dom.ASTRequestor;
...
import org.summer.sdt.internal.corext.refactoring.changes.CreateCompilationUnitChange;
import org.summer.sdt.internal.corext.refactoring.changes.DynamicValidationRefactoringChange;
import org.summer.sdt.internal.corext.refactoring.reorg.ASTNodeDeleteUtil;
import org.summer.sdt.internal.corext.refactoring.structure.constraints.SuperTypeConstraintsModel;
import org.summer.sdt.internal.corext.refactoring.structure.constraints.SuperTypeConstraintsSolver;
import org.summer.sdt.internal.corext.refactoring.structure.constraints.SuperTypeRefactoringProcessor;
...
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ISourceConstraintVariable;
import org.summer.sdt.internal.corext.refactoring.typeconstraints2.ITypeConstraintVariable;
import org.summer.sdt.internal.corext.refactoring.util.RefactoringASTParser;
import org.summer.sdt.internal.corext.refactoring.util.RefactoringFileBuffers;
import org.summer.sdt.internal.corext.refactoring.util.ResourceUtil;
import org.summer.sdt.internal.corext.refactoring.util.TextEditBasedChangeManager;
...
public final class ExtractInterfaceProcessor extends SuperTypeRefactoringProcessor {
	...
	public static final String IDENTIFIER= "org.summer.sdt.ui.extractInterfaceProcessor"; //$NON-NLS-1$

	/** The extract interface group category set */
	private static final GroupCategorySet SET_EXTRACT_INTERFACE= new GroupCategorySet(new GroupCategory("org.summer.sdt.internal.corext.extractInterface", //$NON-NLS-1$
	...
	/*
	 * @see org.summer.sdt.internal.corext.refactoring.structure.constraints.SuperTypeRefactoringProcessor#createContraintSolver(org.summer.sdt.internal.corext.refactoring.structure.constraints.SuperTypeConstraintsModel)
	 */
	@Override
