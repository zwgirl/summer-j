...
public class CompilationUnitRewrite {
	 ...
	 * @see org.summer.sdt.core.dom.ASTParser#setResolveBindings(boolean)
	 ...
	 * @see org.summer.sdt.core.dom.ASTParser#setStatementsRecovery(boolean)
	 */
	 ...
	 * @see org.summer.sdt.core.dom.ASTParser#setBindingsRecovery(boolean)
	 */
	 ...
	 * 
	 * @return a {@link org.summer.sdt.core.refactoring.CompilationUnitChange}, or <code>null</code> for an empty change
	 * @throws CoreException when text buffer acquisition or import rewrite text edit creation fails
	 * @throws IllegalArgumentException when the AST rewrite encounters problems
	 * @deprecated since 3.5, replaced by {@link #createChange(boolean)}
	 */
	public org.summer.sdt.internal.corext.refactoring.changes.CompilationUnitChange createChange() throws CoreException {
		CompilationUnitChange change= createChange(true);
		if (change == null)
			return null;
		return new org.summer.sdt.internal.corext.refactoring.changes.CompilationUnitChange(change);
	}
