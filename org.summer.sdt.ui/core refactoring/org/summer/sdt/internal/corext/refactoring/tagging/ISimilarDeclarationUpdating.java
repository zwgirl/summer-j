 ...
 *******************************************************************************/
package org.summer.sdt.internal.corext.refactoring.tagging;
...
public interface ISimilarDeclarationUpdating {
	 ...
	 * "org.summer.sdt.ui.refactoring.handlesSimilarDeclarations" to "false".
	 */
	 ...
	 *
	 * @param selectedStrategy one of the STRATEGY_* constants in {@link org.summer.sdt.internal.corext.refactoring.rename.RenamingNameSuggestor}
	 */
	 ...
	 *
	 * @return one of the STRATEGY_* constants in {@link org.summer.sdt.internal.corext.refactoring.rename.RenamingNameSuggestor}
	 */
