...
public class CodeTemplateContextType extends TemplateContextType {
	...
	private static final String CODETEMPLATES_PREFIX= "org.summer.sdt.ui.text.codetemplates."; //$NON-NLS-1$
	...
	/*
	 * @see org.summer.sdt.internal.corext.template.ContextType#validateVariables(org.summer.sdt.internal.corext.template.TemplateVariable[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.corext.template.ContextType#createContext()
	 */
	...
	/*
	 * @see org.summer.sdt.internal.corext.template.ContextType#validate(java.lang.String)
	 */
	@Override
