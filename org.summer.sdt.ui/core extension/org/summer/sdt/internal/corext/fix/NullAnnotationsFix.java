...
import org.summer.sdt.internal.corext.fix.NullAnnotationsRewriteOperations.RemoveRedundantAnnotationRewriteOperation;
import org.summer.sdt.internal.corext.fix.NullAnnotationsRewriteOperations.SignatureAnnotationRewriteOperation;
...
public class NullAnnotationsFix extends CompilationUnitRewriteOperationsFix {
	...
	public static ICleanUpFix createCleanUp(CompilationUnit compilationUnit, IProblemLocation[] locations, int problemID) {
		...
		if (locations == null) {
			org.summer.sdt.core.compiler.IProblem[] problems= compilationUnit.getProblems();
