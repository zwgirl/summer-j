...
public class ControlStatementsFix extends CompilationUnitRewriteOperationsFix {
	...
	private final static class ControlStatementFinder extends GenericVisitor {
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.corext.dom.GenericVisitor#visit(org.summer.sdt.core.dom.DoStatement)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.corext.dom.GenericVisitor#visit(org.summer.sdt.core.dom.ForStatement)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.corext.dom.GenericVisitor#visit(org.summer.sdt.core.dom.IfStatement)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.corext.dom.GenericVisitor#visit(org.summer.sdt.core.dom.WhileStatement)
		 */
		@Override
