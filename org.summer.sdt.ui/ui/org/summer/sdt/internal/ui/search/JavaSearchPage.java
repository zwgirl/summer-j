...
import org.summer.sdt.internal.ui.search.MatchLocations.MatchLocationSelectionDialog;
...
public class JavaSearchPage extends DialogPage implements ISearchPage {
	...
	public static final String PARTICIPANT_EXTENSION_POINT= "org.summer.sdt.ui.queryParticipants"; //$NON-NLS-1$

	public static final String EXTENSION_POINT_ID= "org.summer.sdt.ui.JavaSearchPage"; //$NON-NLS-1$
	...
	/*private Control createParticipants(Composite result) {
		...
		selectParticipants.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				PreferencePageSupport.showPreferencePage(getShell(), "org.summer.sdt.ui.preferences.SearchParticipantsExtensionPoint", new SearchParticipantsExtensionPoint()); //$NON-NLS-1$
			}
