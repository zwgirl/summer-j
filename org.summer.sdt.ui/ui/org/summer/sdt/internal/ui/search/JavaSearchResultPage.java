...
import org.summer.sdt.internal.ui.viewsupport.ProblemTableViewer;
...
public class JavaSearchResultPage extends AbstractTextSearchViewPage implements IAdaptable {
	...
	private static final String KEY_GROUPING= "org.summer.sdt.search.resultpage.grouping"; //$NON-NLS-1$
	private static final String KEY_SORTING= "org.summer.sdt.search.resultpage.sorting"; //$NON-NLS-1$
	private static final String KEY_LIMIT_ENABLED= "org.summer.sdt.search.resultpage.limit_enabled"; //$NON-NLS-1$
	private static final String KEY_LIMIT= "org.summer.sdt.search.resultpage.limit"; //$NON-NLS-1$

	private static final String GROUP_GROUPING= "org.summer.sdt.search.resultpage.grouping"; //$NON-NLS-1$
	private static final String GROUP_FILTERING = "org.summer.sdt.search.resultpage.filtering"; //$NON-NLS-1$
