 ...
 *******************************************************************************/
package org.summer.sdt.internal.ui.propertiesfileeditor;
...
public class PropertiesFileSourceViewerConfiguration extends TextSourceViewerConfiguration {
	...
	private static final IContentType PROPERTIES_CONTENT_TYPE= Platform.getContentTypeManager().getContentType("org.summer.sdt.core.javaProperties"); //$NON-NLS-1$
	...
	protected Map<String, IAdaptable> getHyperlinkDetectorTargets(ISourceViewer sourceViewer) {
		...
		targets.put("org.summer.sdt.ui.PropertiesFileEditor", fTextEditor); //$NON-NLS-1$
		return targets;
	}
