...
public class PropertiesFileDocumentProvider extends TextFileDocumentProvider {
	...
	private static final IContentType JAVA_PROPERTIES_FILE_CONTENT_TYPE= Platform.getContentTypeManager().getContentType("org.summer.sdt.core.javaProperties"); //$NON-NLS-1$
