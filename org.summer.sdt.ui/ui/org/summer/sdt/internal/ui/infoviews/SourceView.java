...
import org.summer.sdt.internal.ui.javaeditor.JavaSourceViewer;
import org.summer.sdt.internal.ui.text.JavaCodeReader;
import org.summer.sdt.internal.ui.text.SimpleJavaSourceViewerConfiguration;
...
public class SourceView extends AbstractInfoView {
	...
	private static final String SYMBOLIC_FONT_NAME= "org.summer.sdt.ui.editors.textfont"; //$NON-NLS-1$
	...
	protected void createActions() {
		...
		fOpen= new OpenAction(getViewSite()) {
			...
			/*
			 * @see org.summer.sdt.ui.actions.SelectionDispatchAction#getSelection()
			 */
			@Override
			...
			/*
			 * @see org.summer.sdt.ui.actions.OpenAction#run(IStructuredSelection)
			 */
			@Override
			...
			/*
			 * @see org.summer.sdt.ui.actions.OpenAction#getElementToOpen(Object)
			 */
			@Override
			...
			/*
			 * @see org.summer.sdt.ui.actions.OpenAction#run(Object[])
			 */
			@Override
	...
	protected String getBackgroundColorKey() {
		return "org.summer.sdt.ui.DeclarationView.backgroundColor";		 //$NON-NLS-1$
	}
