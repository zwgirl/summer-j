...
public class BasicJavaEditorActionContributor extends BasicTextEditorActionContributor {
	...
	public void setActiveEditor(IEditorPart part) {
		...
		actionBars.setGlobalActionHandler("org.summer.sdt.internal.ui.actions.OpenHyperlink", getAction(textEditor, ITextEditorActionConstants.OPEN_HYPERLINK)); //$NON-NLS-1$
	}
