 ...
 * 
 */
class GoToMatchingTagAction extends Action { 
	
	public final static String GOTO_MATCHING_TAG= "GotoMatchingTag"; //$NON-NLS-1$
	...
	public GoToMatchingTagAction(JavaEditor editor) {
	...
	void removeAnnotation(boolean allMatching) {
		ITextEditor textEditor = fEditor;
		if (textEditor == null) {
			if (DEBUG) {
