...
import org.summer.sdt.ui.SharedASTProvider.WAIT_FLAG;
...
public final class ASTProvider {
	 ...
	 * @since 3.0
	 */
	private static final boolean DEBUG= "true".equalsIgnoreCase(Platform.getDebugOption("org.summer.sdt.ui/debug/ASTProvider"));  //$NON-NLS-1$//$NON-NLS-2$
	 ...
	 * @param progressMonitor the progress monitor
	 * @see org.summer.sdt.internal.ui.text.java.IJavaReconcilingListener#reconciled(CompilationUnit,
