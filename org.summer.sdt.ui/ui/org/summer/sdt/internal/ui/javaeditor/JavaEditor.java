...
import org.summer.sdt.core.util.IModifierConstants;
...
import org.summer.sdt.internal.ui.actions.CopyQualifiedNameAction;
import org.summer.sdt.internal.ui.actions.FoldingActionGroup;
import org.summer.sdt.internal.ui.actions.SelectionConverter;
import org.summer.sdt.internal.ui.javaeditor.breadcrumb.EditorBreadcrumb;
import org.summer.sdt.internal.ui.javaeditor.breadcrumb.IBreadcrumb;
import org.summer.sdt.internal.ui.javaeditor.selectionactions.GoToNextPreviousMemberAction;
import org.summer.sdt.internal.ui.javaeditor.selectionactions.SelectionHistory;
import org.summer.sdt.internal.ui.javaeditor.selectionactions.StructureSelectEnclosingAction;
import org.summer.sdt.internal.ui.javaeditor.selectionactions.StructureSelectHistoryAction;
import org.summer.sdt.internal.ui.javaeditor.selectionactions.StructureSelectNextAction;
import org.summer.sdt.internal.ui.javaeditor.selectionactions.StructureSelectPreviousAction;
import org.summer.sdt.internal.ui.javaeditor.selectionactions.StructureSelectionAction;
import org.summer.sdt.internal.ui.search.BreakContinueTargetFinder;
import org.summer.sdt.internal.ui.search.ExceptionOccurrencesFinder;
import org.summer.sdt.internal.ui.search.IOccurrencesFinder;
import org.summer.sdt.internal.ui.search.ImplementOccurrencesFinder;
import org.summer.sdt.internal.ui.search.MethodExitsFinder;
import org.summer.sdt.internal.ui.search.OccurrencesFinder;
import org.summer.sdt.internal.ui.search.IOccurrencesFinder.OccurrenceLocation;
import org.summer.sdt.internal.ui.text.DocumentCharacterIterator;
import org.summer.sdt.internal.ui.text.JavaChangeHover;
import org.summer.sdt.internal.ui.text.JavaPairMatcher;
import org.summer.sdt.internal.ui.text.JavaWordFinder;
import org.summer.sdt.internal.ui.text.JavaWordIterator;
import org.summer.sdt.internal.ui.text.PreferencesAdapter;
import org.summer.sdt.internal.ui.text.java.hover.JavaExpandHover;
import org.summer.sdt.internal.ui.text.java.hover.SourceViewerInformationControl;
import org.summer.sdt.internal.ui.util.ElementValidator;
import org.summer.sdt.internal.ui.util.JavaUIHelp;
import org.summer.sdt.internal.ui.viewsupport.ISelectionListenerWithAST;
import org.summer.sdt.internal.ui.viewsupport.IViewPartInputProvider;
import org.summer.sdt.internal.ui.viewsupport.SelectionListenerWithASTManager;
...
import org.summer.sdt.ui.text.folding.IJavaFoldingStructureProvider;
import org.summer.sdt.ui.text.folding.IJavaFoldingStructureProviderExtension;
...
public abstract class JavaEditor extends AbstractDecoratedTextEditor implements IViewPartInputProvider {
	...
	protected class NavigateNextSubWordAction extends NextSubWordAction {
		...
		/*
		 * @see org.summer.sdt.internal.ui.javaeditor.JavaEditor.NextSubWordAction#setCaretPosition(int)
		 */
		@Override
	...
	protected class NavigatePreviousSubWordAction extends PreviousSubWordAction {
		...
		/*
		 * @see org.summer.sdt.internal.ui.javaeditor.JavaEditor.PreviousSubWordAction#setCaretPosition(int)
		 */
		@Override
		protected void setCaretPosition(final int position) {
			getTextWidget().setCaretOffset(modelOffset2WidgetOffset(getSourceViewer(), position));
	...
	protected void initializeKeyBindingScopes() {
		setKeyBindingScopes(new String[] { "org.summer.sdt.ui.javaEditorScope" });  //$NON-NLS-1$
	}
	...
	private void createDeprecatedShowInPackageExplorerAction() {
		IAction action= new org.summer.sdt.ui.actions.ShowInPackageViewAction(this);
	...
	/*
	 * @see org.summer.sdt.internal.ui.viewsupport.IViewPartInputProvider#getViewPartInput()
	 */
	...
	class OccurrencesFinderJob extends Job {
		...
		public IStatus run(IProgressMonitor progressMonitor) {
			...
			for (int i= 0; i < length; i++) {
				...
				String annotationType= (location.getFlags() == IOccurrencesFinder.F_WRITE_OCCURRENCE) ? "org.summer.sdt.ui.occurrences.write" : "org.summer.sdt.ui.occurrences"; //$NON-NLS-1$ //$NON-NLS-2$
...
//		sourceViewer.revealRange(targetOffset, direction);
	...
	protected String[] collectContextMenuPreferencePages() {
		...
		result[0]= "org.summer.sdt.ui.preferences.JavaEditorPreferencePage"; //$NON-NLS-1$
		result[1]= "org.summer.sdt.ui.preferences.JavaTemplatePreferencePage"; //$NON-NLS-1$
		result[2]= "org.summer.sdt.ui.preferences.CodeAssistPreferencePage"; //$NON-NLS-1$
		result[3]= "org.summer.sdt.ui.preferences.CodeAssistPreferenceAdvanced"; //$NON-NLS-1$
		result[4]= "org.summer.sdt.ui.preferences.JavaEditorHoverPreferencePage"; //$NON-NLS-1$
		result[5]= "org.summer.sdt.ui.preferences.JavaEditorColoringPreferencePage"; //$NON-NLS-1$
		result[6]= "org.summer.sdt.ui.preferences.FoldingPreferencePage"; //$NON-NLS-1$
		result[7]= "org.summer.sdt.ui.preferences.MarkOccurrencesPreferencePage"; //$NON-NLS-1$
		result[8]= "org.summer.sdt.ui.preferences.SmartTypingPreferencePage"; //$NON-NLS-1$
		result[9]= "org.summer.sdt.ui.preferences.SaveParticipantPreferencePage"; //$NON-NLS-1$
