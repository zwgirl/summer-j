...
import org.summer.sdt.internal.corext.fix.CleanUpPreferenceUtil;
import org.summer.sdt.internal.corext.util.JavaModelUtil;
import org.summer.sdt.internal.ui.IJavaHelpContextIds;
import org.summer.sdt.internal.ui.IJavaStatusConstants;
import org.summer.sdt.internal.ui.JavaPlugin;
import org.summer.sdt.internal.ui.actions.AddBlockCommentAction;
import org.summer.sdt.internal.ui.actions.CompositeActionGroup;
import org.summer.sdt.internal.ui.actions.IndentAction;
import org.summer.sdt.internal.ui.actions.RemoveBlockCommentAction;
import org.summer.sdt.internal.ui.actions.SurroundWithActionGroup;
import org.summer.sdt.internal.ui.compare.LocalHistoryActionGroup;
import org.summer.sdt.internal.ui.preferences.SaveParticipantPreferencePage;
import org.summer.sdt.internal.ui.text.ContentAssistPreference;
import org.summer.sdt.internal.ui.text.JavaHeuristicScanner;
import org.summer.sdt.internal.ui.text.SmartBackspaceManager;
import org.summer.sdt.internal.ui.text.Symbols;
import org.summer.sdt.internal.ui.text.correction.CorrectionCommandInstaller;
import org.summer.sdt.internal.ui.text.java.IJavaReconcilingListener;
import org.summer.sdt.internal.ui.text.java.JavaFormattingContext;
...
public class CompilationUnitEditor extends JavaEditor implements IJavaReconcilingListener {
	private static final boolean CODE_ASSIST_DEBUG= "true".equalsIgnoreCase(Platform.getDebugOption("org.summer.sdt.ui/debug/ResultCollector"));  //$NON-NLS-1$//$NON-NLS-2$
	...
	private class ExitPolicy implements IExitPolicy {
		...
		/*
		 * @see org.summer.sdt.internal.ui.text.link.LinkedPositionUI.ExitPolicy#doExit(org.summer.sdt.internal.ui.text.link.LinkedPositionManager, org.eclipse.swt.events.VerifyEvent, int, int)
		 */
...
//			removeActionActivationCode(ITextEditorActionConstants.SHIFT_RIGHT);
	...
	/*
	 * @see org.summer.sdt.internal.ui.javaeditor.JavaEditor#installOverrideIndicator(boolean)
	 * @since 3.0
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.javaeditor.JavaEditor#uninstallOverrideIndicator()
	 * @since 3.0
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.javaeditor.JavaEditor#createJavaSourceViewer(org.eclipse.swt.widgets.Composite, org.eclipse.jface.text.source.IVerticalRuler, org.eclipse.jface.text.source.IOverviewRuler, boolean, int)
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.text.java.IJavaReconcilingListener#aboutToBeReconciled()
	 * @since 3.0
	 */
	...
	/*
	 * @see org.summer.sdt.internal.ui.text.java.IJavaReconcilingListener#reconciled(CompilationUnit, boolean, IProgressMonitor)
	 * @since 3.0
	 */
	...
	/*
	 * @see org.summer.sdt.internal.ui.javaeditor.JavaEditor#getAdapter(java.lang.Class)
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.javaeditor.JavaEditor#createNavigationActions()
	 */
	@Override
