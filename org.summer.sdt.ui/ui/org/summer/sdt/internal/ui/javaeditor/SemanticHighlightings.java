...
import org.summer.sdt.core.dom.HtmlAttribute;
...
import org.summer.sdt.core.dom.HtmlElement;
...
public class SemanticHighlightings {
	...
	private static final class StaticFinalFieldHighlighting extends SemanticHighlighting {
		...
		/*
		 * @see org.summer.sdt.internal.ui.javaeditor.SemanticHighlighting#consumes(org.summer.sdt.internal.ui.javaeditor.SemanticToken)
		 */
		@Override
	...
	private static final class AutoboxHighlighting extends SemanticHighlighting {
		...
		/*
		 * @see org.summer.sdt.internal.ui.javaeditor.SemanticHighlighting#consumesLiteral(org.summer.sdt.internal.ui.javaeditor.SemanticToken)
		 */
		@Override
	...
	static final class DeprecatedMemberHighlighting extends SemanticHighlighting {
		...
		/*
		 * @see org.summer.sdt.internal.ui.javaeditor.SemanticHighlighting#isStrikethroughByDefault()
		 * @since 3.1
		 */
		@Override
	...
	private static final class XAMLElementHighlighting extends SemanticHighlighting {
		...
		public boolean consumes(SemanticToken token) {
			...
			if(parent instanceof SimpleType){
				if(parent.getParent() instanceof HtmlElement){
					IBinding binding= getBinding(token);
	...
	static final class XAMLAttributeHighlighting extends SemanticHighlighting {
		...
		public boolean consumes(SemanticToken token) {
			...
			if(parent instanceof FieldAccess){
				if(parent.getParent() instanceof HtmlAttribute){
					IBinding binding= getBinding(token);
					return binding != null && binding.getKind() == IBinding.VARIABLE && ((IVariableBinding)binding).isField();
				}
			} 
