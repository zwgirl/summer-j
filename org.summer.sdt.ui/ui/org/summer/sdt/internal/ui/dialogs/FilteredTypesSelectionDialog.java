...
import org.summer.sdt.internal.corext.util.TypeInfoFilter;
import org.summer.sdt.internal.corext.util.TypeInfoRequestorAdapter;
...
import org.summer.sdt.internal.ui.preferences.TypeFilterPreferencePage;
import org.summer.sdt.internal.ui.search.JavaSearchScopeFactory;
import org.summer.sdt.internal.ui.util.ExceptionHandler;
import org.summer.sdt.internal.ui.util.TypeNameMatchLabelProvider;
...
import org.summer.sdt.ui.dialogs.ITypeInfoFilterExtension;
import org.summer.sdt.ui.dialogs.ITypeInfoImageProvider;
import org.summer.sdt.ui.dialogs.ITypeSelectionComponent;
...
public class FilteredTypesSelectionDialog extends FilteredItemsSelectionDialog implements ITypeSelectionComponent {
	...
	private static final String DIALOG_SETTINGS= "org.summer.sdt.internal.ui.dialogs.FilteredTypesSelectionDialog"; //$NON-NLS-1$
	...
	/*
	 * @see org.summer.sdt.ui.dialogs.ITypeSelectionComponent#triggerSearch()
	 */
	...
	private class TypeItemsFilter extends ItemsFilter {
		...
		/**
		 * @return search flags
		 * @see org.summer.sdt.core.search.SearchPattern#getMatchRule()
		 */
		@Override
	...
	private static class TypeSearchRequestor extends TypeNameMatchRequestor {
		 ...
		 * (non-Javadoc)
		 *
		 * @see org.summer.sdt.core.search.TypeNameMatchRequestor#acceptTypeNameMatch(org.summer.sdt.core.search.TypeNameMatch)
		 */
		@Override
