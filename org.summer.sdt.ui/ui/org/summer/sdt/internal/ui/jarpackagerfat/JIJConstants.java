 ...
 *******************************************************************************/
package org.summer.sdt.internal.ui.jarpackagerfat;
 ...
 * {@link org.summer.sdt.internal.jarinjarloader}.
 * 
 * @since 3.6
 */
final class JIJConstants {
	...
	/**
	 * This is <code>{@link org.summer.sdt.internal.jarinjarloader.JarRsrcLoader}.class.getName()</code>,
	 * but that's not visible for the PDE builder when building the org.summer.sdt.ui plug-in.
	 */
	static final String LOADER_MAIN_CLASS                    = "org.summer.sdt.internal.jarinjarloader.JarRsrcLoader";  //$NON-NLS-1$
}
