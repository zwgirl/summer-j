...
import org.summer.sdt.internal.ui.text.java.CompletionProposalCategory;
...
final class CodeAssistAdvancedConfigurationBlock extends OptionsConfigurationBlock {
	...
	private final class ModelElement {
		...
		ModelElement(CompletionProposalCategory category, PreferenceModel model) {
			...
			fCommand= commandSvc.getCommand("org.summer.sdt.ui.specific_content_assist.command"); //$NON-NLS-1$
			IParameter type;
			try {
	...
	/*
	 * @see org.summer.sdt.internal.ui.preferences.OptionsConfigurationBlock#updateControls()
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.preferences.OptionsConfigurationBlock#processChanges(org.eclipse.ui.preferences.IWorkbenchPreferenceContainer)
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.preferences.OptionsConfigurationBlock#dispose()
	 */
	@Override
	public void dispose() {
