...
package org.summer.sdt.internal.ui.preferences.formatter;
...
import org.summer.sdt.internal.ui.preferences.formatter.ProfileManager.CustomProfile;
...
public class ProfileVersioner implements IProfileVersioner {
	...
	private static void version3to4(Map<String, String> oldSettings) {
		checkAndReplace(oldSettings,
			"org.summer.sdt.core.align_type_members_on_columns", //$NON-NLS-1$
			DefaultCodeFormatterConstants.FORMATTER_ALIGN_TYPE_MEMBERS_ON_COLUMNS);

		checkAndReplace(oldSettings,
			"org.summer.sdt.core.formatter.insert_space_after_comma__in_superinterfaces", //$NON-NLS-1$
			DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_SUPERINTERFACES);

		checkAndReplace(oldSettings,
			"org.summer.sdt.core.formatter.insert_space_before_comma__in_superinterfaces", //$NON-NLS-1$
			DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_SUPERINTERFACES);

		checkAndReplace(oldSettings,
			"org.summer.sdt.core.formatter.insert_space_between_empty_arguments_in_method_invocation", //$NON-NLS-1$
			DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_INVOCATION);
	}

	private static void version4to5(Map<String, String> oldSettings) {
		checkAndReplace(oldSettings,
			"org.summer.sdt.core.formatter.indent_block_statements", //$NON-NLS-1$
	...
	private static void version5to6(Map<String, String> oldSettings) {
		checkAndReplace(oldSettings,
			"org.summer.sdt.core.formatter.insert_new_line_in_control_statements", //$NON-NLS-1$
			new String[] {
