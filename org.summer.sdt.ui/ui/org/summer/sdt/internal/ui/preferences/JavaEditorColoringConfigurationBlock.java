...
import org.summer.sdt.internal.ui.javaeditor.SemanticHighlighting;
import org.summer.sdt.internal.ui.javaeditor.SemanticHighlightingManager;
import org.summer.sdt.internal.ui.javaeditor.SemanticHighlightings;
import org.summer.sdt.internal.ui.javaeditor.SemanticHighlightingManager.HighlightedRange;
import org.summer.sdt.internal.ui.preferences.OverlayPreferenceStore.OverlayKey;
import org.summer.sdt.internal.ui.text.JavaColorManager;
...
class JavaEditorColoringConfigurationBlock extends AbstractConfigurationBlock {
	...
	/*
	 * @see org.summer.sdt.internal.ui.preferences.IPreferenceConfigurationBlock#dispose()
	 */
	@Override
	public void dispose() {
		uninstallSemanticHighlighting();
		...
		link.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if ("org.eclipse.ui.preferencePages.GeneralTextEditor".equals(e.text)) //$NON-NLS-1$
					...
					PreferencesUtil.createPreferenceDialogOn(parent.getShell(), e.text, null, "selectFont:org.summer.sdt.ui.editors.textfont"); //$NON-NLS-1$
			}
		});
