...
import org.summer.sdt.internal.ui.propertiesfileeditor.IPropertiesFilePartitions;
import org.summer.sdt.internal.ui.propertiesfileeditor.PropertiesFileDocumentSetupParticipant;
import org.summer.sdt.internal.ui.propertiesfileeditor.PropertiesFileSourceViewerConfiguration;
		...
		link.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if ("org.eclipse.ui.preferencePages.GeneralTextEditor".equals(e.text)) //$NON-NLS-1$
					...
					PreferencesUtil.createPreferenceDialogOn(getShell(), e.text, null, "selectFont:org.summer.sdt.ui.PropertiesFileEditor.textfont"); //$NON-NLS-1$
			}
		});
