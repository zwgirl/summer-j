...
import org.summer.sdt.internal.corext.callhierarchy.CallLocation;
import org.summer.sdt.internal.corext.callhierarchy.MethodWrapper;
import org.summer.sdt.internal.corext.callhierarchy.RealCallers;
...
public class CallHierarchyViewPart extends ViewPart implements ICallHierarchyViewPart, ISelectionChangedListener {
	...
	private class CallHierarchySelectionProvider extends SelectionProviderMediator {
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.ui.typehierarchy.SelectionProviderMediator#getSelection()
		 */
		@Override
	...
	static final String ID_CALL_HIERARCHY = "org.summer.sdt.callhierarchy.view"; //$NON-NLS-1$
