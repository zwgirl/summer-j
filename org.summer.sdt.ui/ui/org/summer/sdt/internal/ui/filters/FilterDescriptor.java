 ...
 * "org.summer.sdt.ui.javaElementFilters" extension point.
 *
 * since 2.0
 */
public class FilterDescriptor implements Comparable<FilterDescriptor>, IPluginContribution {
	...
	private FilterDescriptor(IConfigurationElement element) {
		...
		Assert.isTrue(isPatternFilter() ^ isCustomFilter(), "An extension for extension-point org.summer.sdt.ui.javaElementFilters does not specify a correct filter"); //$NON-NLS-1$
		Assert.isNotNull(getId(), "An extension for extension-point org.summer.sdt.ui.javaElementFilters does not provide a valid ID"); //$NON-NLS-1$
		Assert.isNotNull(getName(), "An extension for extension-point org.summer.sdt.ui.javaElementFilters does not provide a valid name"); //$NON-NLS-1$
	}
