...
public class ExtractSuperClassAction extends SelectionDispatchAction {
	 ...
	 * <code>"org.summer.sdt.ui.edit.text.java.extract.superclass"</code>).
	 *
	 * @since 3.2
	 */
	public static final String EXTRACT_SUPERTYPE= "org.summer.sdt.ui.edit.text.java.extract.superclass"; //$NON-NLS-1$

	/**
	 * Refactor menu: name of standard Extract Supertype global action (value
	 * <code>"org.summer.sdt.ui.actions.ExtractSuperclass"</code>).
	 *
	 * @since 3.2
	 */
	public static final String EXTRACT_SUPERTYPES= "org.summer.sdt.ui.actions.ExtractSuperclass"; //$NON-NLS-1$
