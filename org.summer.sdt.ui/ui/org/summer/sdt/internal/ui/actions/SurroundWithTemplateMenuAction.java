...
import org.summer.sdt.internal.ui.text.correction.QuickTemplateProcessor;
import org.summer.sdt.ui.JavaUI;
import org.summer.sdt.ui.actions.SurroundWithTryCatchAction;
import org.summer.sdt.ui.actions.SurroundWithTryMultiCatchAction;
...
public class SurroundWithTemplateMenuAction implements IWorkbenchWindowPulldownDelegate2 {
	...
	//TODO make api
	public static final String SURROUND_WITH_QUICK_MENU_ACTION_ID= "org.summer.sdt.ui.edit.text.java.surround.with.quickMenu";  //$NON-NLS-1$

	private static final String JAVA_TEMPLATE_PREFERENCE_PAGE_ID= "org.summer.sdt.ui.preferences.JavaTemplatePreferencePage"; //$NON-NLS-1$

	private static final String CODE_TEMPLATE_PREFERENCE_PAGE_ID= "org.summer.sdt.ui.preferences.CodeTemplatePreferencePage"; //$NON-NLS-1$
