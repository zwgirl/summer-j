...
import org.summer.sdt.internal.ui.viewsupport.LinkedProposalModelPresenter;
...
public class LinkedCorrectionProposal extends ASTRewriteCorrectionProposal {
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.ui.text.correction.ChangeCorrectionProposal#performChange(org.eclipse.jface.text.IDocument, org.eclipse.ui.IEditorPart)
	 */
	@Override
