...
import org.summer.sdt.internal.corext.fix.UnimplementedCodeFix.MakeTypeAbstractOperation;
...
import org.summer.sdt.internal.ui.text.correction.proposals.ModifierChangeCorrectionProposal;
...
public class ModifierCorrectionSubProcessor {
	...
	private static class ModifierLinkedModeProposal extends LinkedProposalPositionGroup.Proposal {
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.corext.fix.PositionGroup.Proposal#computeEdits(int, org.eclipse.jface.text.link.LinkedPosition, char, int, org.eclipse.jface.text.link.LinkedModeModel)
		 */
		@Override
