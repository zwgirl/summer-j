...
import org.summer.sdt.internal.ui.text.CombinedWordRule;
import org.summer.sdt.internal.ui.text.ISourceVersionDependent;
import org.summer.sdt.internal.ui.text.JavaWhitespaceDetector;
import org.summer.sdt.internal.ui.text.JavaWordDetector;
...
public final class JavaCodeScanner extends AbstractJavaScanner {
	...
	private static class VersionedWordMatcher extends CombinedWordRule.WordMatcher implements ISourceVersionDependent {
		...
		/*
		 * @see org.summer.sdt.internal.ui.text.ISourceVersionDependent#setSourceVersion(java.lang.String)
		 */
		...
		/*
		 * @see org.summer.sdt.internal.ui.text.CombinedWordRule.WordMatcher#evaluate(org.eclipse.jface.text.rules.ICharacterScanner, org.summer.sdt.internal.ui.text.CombinedWordRule.CharacterBuffer)
		 */
		@Override
	...
	static String[] fgKeywords= {
		...
		"default", "do", "debugger",//$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
		...
		"volatile", //$NON-NLS-1$
		"while", //$NON-NLS-1$
		"function", "var" //$NON-NLS-2$ //$NON-NLS-1$
	};

	private static final String INTERFACE= "interface";  //$NON-NLS-1$
	private static final String RETURN= "return"; //$NON-NLS-1$
//	private static String[] fgJava14Keywords= { "assert" }; //$NON-NLS-1$   //cym 2015-04-08
...
//			j14Matcher.addWord(fgJava14Keywords[i], token);
	...
	/*
	 * @see org.summer.sdt.internal.ui.text.AbstractJavaScanner#getBoldKey(java.lang.String)
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.text.AbstractJavaScanner#getItalicKey(java.lang.String)
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.text.AbstractJavaScanner#getStrikethroughKey(java.lang.String)
	 */
	@Override
	...
	/*
	 * @see org.summer.sdt.internal.ui.text.AbstractJavaScanner#getUnderlineKey(java.lang.String)
	 */
	@Override
