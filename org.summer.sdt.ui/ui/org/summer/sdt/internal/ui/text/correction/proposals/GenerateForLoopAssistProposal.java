...
public class GenerateForLoopAssistProposal extends LinkedCorrectionProposal {
	...
	/*
	 * (non-Javadoc)
	 * @see org.summer.sdt.ui.text.java.correction.ASTRewriteCorrectionProposal#getRewrite()
	 */
	@Override
	 ...
	 * @param operator the {@link org.summer.sdt.core.dom.InfixExpression.Operator} to use in the
