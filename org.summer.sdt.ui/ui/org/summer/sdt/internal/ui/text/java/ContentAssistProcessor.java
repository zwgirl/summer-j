 ...
 * {@link org.summer.sdt.ui.text.java.IJavaCompletionProposalComputer}s contributed via the
 * <code>org.summer.sdt.ui.javaCompletionProposalComputer</code> extension point.
 * <p>
		...
		if (OptionalMessageDialog.isDialogEnabled(PREF_WARN_ABOUT_EMPTY_ASSIST_CATEGORY)) {
	        ...
	        if (restoreId == returnValue || settingsId == returnValue) {
	        	...
	        	if (settingsId == returnValue)
					PreferencesUtil.createPreferenceDialogOn(shell, "org.summer.sdt.ui.preferences.CodeAssistPreferenceAdvanced", null, null).open(); //$NON-NLS-1$
