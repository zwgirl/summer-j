...
public final class JavaHeuristicScanner implements Symbols {
	...
	private static class NonWhitespace extends StopCondition {
		/*
		 * @see org.summer.sdt.internal.ui.text.JavaHeuristicScanner.StopCondition#stop(char)
		 */
		@Override
	...
	private final class NonWhitespaceDefaultPartition extends NonWhitespace {
		...
		/*
		 * @see org.summer.sdt.internal.ui.text.JavaHeuristicScanner.StopCondition#nextPosition(int, boolean)
		 */
		@Override
		public int nextPosition(int position, boolean forward) {
	...
	private final class CharacterMatch extends StopCondition {
		...
		/*
		 * @see org.summer.sdt.internal.ui.text.JavaHeuristicScanner.StopCondition#stop(char, int)
		 */
		@Override
		public boolean stop(char ch, int position, boolean forward) {
		...
		switch (s.length()) {
			...
			case 3:
				...
				if ("new".equals(s)) //$NON-NLS-1$
					return TokenNEW;
				if ("let".equals(s)) //$NON-NLS-1$  //cym 2015-03-24
					return TokenLET;
				break;
			case 4:
