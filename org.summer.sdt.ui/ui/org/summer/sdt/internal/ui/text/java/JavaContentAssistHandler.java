...
import org.summer.sdt.internal.ui.javaeditor.SpecificContentAssistExecutor;
...
public final class JavaContentAssistHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		String categoryId= event.getParameter("org.summer.sdt.ui.specific_content_assist.category_id"); //$NON-NLS-1$
		if (categoryId == null)
			return null;
