...
public final class JavadocContentAssistInvocationContext extends JavaContentAssistInvocationContext {
	 ...
	 * @param offset
	 * @param editor
	 * @param flags see {@link org.summer.sdt.ui.text.java.IJavadocCompletionProcessor#RESTRICT_TO_MATCHING_CASE}
	 */
	 ...
	 * @see org.summer.sdt.ui.text.java.IJavadocCompletionProcessor#RESTRICT_TO_MATCHING_CASE
	 */
	public int getFlags() {
		return fFlags;
	}
