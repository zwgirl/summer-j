...
public final class CompatibilityTemplateStore extends ContributionTemplateStore {
	...
	private org.summer.sdt.internal.corext.template.java.TemplateSet fLegacySet;

	public CompatibilityTemplateStore(ContextTypeRegistry registry, IPreferenceStore store, String key, org.summer.sdt.internal.corext.template.java.TemplateSet legacySet) {
	...
	private boolean isCodeTemplates() {
		return fLegacySet instanceof org.summer.sdt.internal.corext.template.java.CodeTemplates;
	}
