...
import org.summer.sdt.internal.ui.filters.CustomFiltersDialog;
import org.summer.sdt.internal.ui.filters.EmptyLibraryContainerFilter;
import org.summer.sdt.internal.ui.filters.FilterDescriptor;
import org.summer.sdt.internal.ui.filters.FilterMessages;
import org.summer.sdt.internal.ui.filters.NamePatternFilter;
...
//			mi.setImage(JavaPluginImages.get(JavaPluginImages.IMG_OBJS_JAVA_WORKING_SET));
	...
	public CustomFiltersActionGroup(String ownerId, StructuredViewer viewer) {
		...
		for (int i= 0; i < filterDescriptors.length; i++) {
			...
			if (existing != null) {
				JavaPlugin.logErrorMessage("WARNING: Duplicate id for extension-point \"org.summer.sdt.ui.javaElementFilters\" in " + ownerId); //$NON-NLS-1$
			}
		}
