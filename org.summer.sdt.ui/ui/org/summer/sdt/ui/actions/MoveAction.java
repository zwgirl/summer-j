...
import org.summer.sdt.internal.ui.refactoring.actions.MoveInstanceMethodAction;
import org.summer.sdt.internal.ui.refactoring.actions.MoveStaticMembersAction;
import org.summer.sdt.internal.ui.refactoring.reorg.ReorgMoveAction;
...
//bug 35748 (no JavaElements for local types).
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.ui.actions.SelectionDispatchAction#setSpecialSelectionProvider(org.eclipse.jface.viewers.ISelectionProvider)
	 */
	@Override
