...
import org.summer.sdt.internal.ui.callhierarchy.OpenCallHierarchyAction;
...
public class OpenViewActionGroup extends ActionGroup {
	...
	public OpenViewActionGroup(IViewPart part, ISelectionProvider selectionProvider) {
		...
		fIsTypeHiararchyViewerOwner= "org.summer.sdt.internal.ui.typehierarchy.TypeHierarchyViewPart".equals(partName); //$NON-NLS-1$
		fIsCallHiararchyViewerOwner= "org.summer.sdt.internal.ui.callhierarchy.CallHierarchyViewPart".equals(partName); //$NON-NLS-1$
	}
