...
public class OpenProjectAction extends SelectionDispatchAction implements IResourceChangeListener {
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.ui.actions.SelectionDispatchAction#selectionChanged(org.eclipse.jface.viewers.ISelection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.ui.actions.SelectionDispatchAction#run(org.eclipse.jface.viewers.ISelection)
	 */
	@Override
