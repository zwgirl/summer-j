 ...
 *******************************************************************************/
package org.summer.sdt.ui.refactoring;
 ...
 * </p>
 *
 * @see org.summer.sdt.core.refactoring.participants.IRefactoringProcessorIds
 * 
 * @since 3.0
 *
...
public interface IRefactoringProcessorIds {
	 ...
	 * (value <code>"org.summer.sdt.ui.renameJavaProjectProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String RENAME_JAVA_PROJECT_PROCESSOR= "org.summer.sdt.ui.renameJavaProjectProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename source folder
	 * (value <code>"org.summer.sdt.ui.renameSourceFolderProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String RENAME_SOURCE_FOLDER_PROCESSOR= "org.summer.sdt.ui.renameSourceFolderProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename package fragment processor
	 * (value <code>"org.summer.sdt.ui.renamePackageProcessor"</code>).
	 *
	 ...
	 */
	public static String RENAME_PACKAGE_FRAGMENT_PROCESSOR= "org.summer.sdt.ui.renamePackageProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename compilation unit processor
	 * (value <code>"org.summer.sdt.ui.renameCompilationUnitProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String RENAME_COMPILATION_UNIT_PROCESSOR= "org.summer.sdt.ui.renameCompilationUnitProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename type processor
	 * (value <code>"org.summer.sdt.ui.renameTypeProcessor"</code>).
	 *
	 ...
	 *
	 */
	public static String RENAME_TYPE_PROCESSOR= "org.summer.sdt.ui.renameTypeProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename method processor
	 * (value <code>"org.summer.sdt.ui.renameMethodProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String RENAME_METHOD_PROCESSOR= "org.summer.sdt.ui.renameMethodProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename field processor
	 * (value <code>"org.summer.sdt.ui.renameFieldProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String RENAME_FIELD_PROCESSOR= "org.summer.sdt.ui.renameFieldProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename enum constant processor
	 * (value <code>"org.summer.sdt.ui.renameEnumConstProcessor"</code>).
	 *
	 * The rename filed processor loads the following participants:
	 * <ul>
	 *   <li>participants registered for renaming <code>IField</code>.</li>
	 ...
	 * @since 3.1
	 */
	public static String RENAME_ENUM_CONSTANT_PROCESSOR= "org.summer.sdt.ui.renameEnumConstProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the rename resource processor
	 * (value <code>"org.summer.sdt.ui.renameResourceProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String RENAME_RESOURCE_PROCESSOR= "org.summer.sdt.ui.renameResourceProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the move resource processor
	 * (value <code>"org.summer.sdt.ui.MoveProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String MOVE_PROCESSOR= "org.summer.sdt.ui.MoveProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the move static member processor
	 * (value <code>"org.summer.sdt.ui.MoveStaticMemberProcessor"</code>).
	 *
	 ...
	 */
	public static String MOVE_STATIC_MEMBERS_PROCESSOR= "org.summer.sdt.ui.MoveStaticMemberProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the delete resource processor
	 * (value <code>"org.summer.sdt.ui.DeleteProcessor"</code>).
	 *
	 ...
	 * </ul>
	 */
	public static String DELETE_PROCESSOR= "org.summer.sdt.ui.DeleteProcessor"; //$NON-NLS-1$

	/**
	 * Processor ID of the copy processor (value <code>"org.summer.sdt.ui.CopyProcessor"</code>).
	 *
	 ...
	 * @since 3.3
	 */
	public static String COPY_PROCESSOR= "org.summer.sdt.ui.CopyProcessor"; //$NON-NLS-1$
}
