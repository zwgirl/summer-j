...
import org.summer.sdt.internal.corext.refactoring.reorg.JavaElementTransfer;
import org.summer.sdt.internal.ui.JavaPlugin;
import org.summer.sdt.internal.ui.JavaUIMessages;
import org.summer.sdt.internal.ui.SharedImages;
import org.summer.sdt.internal.ui.dialogs.FilteredTypesSelectionDialog;
import org.summer.sdt.internal.ui.dialogs.MainTypeSelectionDialog;
import org.summer.sdt.internal.ui.dialogs.MultiMainTypeSelectionDialog;
...
import org.summer.sdt.internal.ui.util.BusyIndicatorRunnableContext;
import org.summer.sdt.ui.dialogs.TypeSelectionExtension;
import org.summer.sdt.ui.text.IColorManager;

/**
 * Central access point for the Java UI plug-in (id <code>"org.summer.sdt.ui"</code>).
...
public final class JavaUI {
	...
	/**
	 * The id of the Java plug-in (value <code>"org.summer.sdt.ui"</code>).
	 */
	public static final String ID_PLUGIN= "org.summer.sdt.ui"; //$NON-NLS-1$

	/**
	 * The id of the Java perspective
	 * (value <code>"org.summer.sdt.ui.JavaPerspective"</code>).
	 */
	public static final String ID_PERSPECTIVE= 		"org.summer.sdt.ui.JavaPerspective"; //$NON-NLS-1$

	/**
	 * The id of the Java hierarchy perspective
	 * (value <code>"org.summer.sdt.ui.JavaHierarchyPerspective"</code>).
	 */
	public static final String ID_HIERARCHYPERSPECTIVE= "org.summer.sdt.ui.JavaHierarchyPerspective"; //$NON-NLS-1$

	/**
	 * The id of the Java action set
	 * (value <code>"org.summer.sdt.ui.JavaActionSet"</code>).
	 */
	public static final String ID_ACTION_SET= "org.summer.sdt.ui.JavaActionSet"; //$NON-NLS-1$

	/**
	 * The id of the Java Element Creation action set
	 * (value <code>"org.summer.sdt.ui.JavaElementCreationActionSet"</code>).
	 *
	 * @since 2.0
	 */
	public static final String ID_ELEMENT_CREATION_ACTION_SET= "org.summer.sdt.ui.JavaElementCreationActionSet"; //$NON-NLS-1$

	/**
	 * The id of the Java Coding action set
	 * (value <code>"org.summer.sdt.ui.CodingActionSet"</code>).
	 *
	 * @since 2.0
	 */
	public static final String ID_CODING_ACTION_SET= "org.summer.sdt.ui.CodingActionSet"; //$NON-NLS-1$

	/**
	 * The id of the Java action set for open actions
	 * (value <code>"org.summer.sdt.ui.A_OpenActionSet"</code>).
	 *
	 * @since 2.0
	 */
	public static final String ID_OPEN_ACTION_SET= "org.summer.sdt.ui.A_OpenActionSet"; //$NON-NLS-1$

	/**
	 * The id of the Java Search action set
	 * (value <code>org.summer.sdt.ui.SearchActionSet"</code>).
	 *
	 * @since 2.0
	 */
	public static final String ID_SEARCH_ACTION_SET= "org.summer.sdt.ui.SearchActionSet"; //$NON-NLS-1$

	/**
	 * The editor part id of the editor that presents Java compilation units
	 * (value <code>"org.summer.sdt.ui.CompilationUnitEditor"</code>).
	 */
	public static final String ID_CU_EDITOR=			"org.summer.sdt.ui.CompilationUnitEditor"; //$NON-NLS-1$

	/**
	 * The editor part id of the editor that presents Java binary class files
	 * (value <code>"org.summer.sdt.ui.ClassFileEditor"</code>).
	 */
	public static final String ID_CF_EDITOR=			"org.summer.sdt.ui.ClassFileEditor"; //$NON-NLS-1$

	/**
	 * The editor part id of the code snippet editor
	 * (value <code>"org.summer.sdt.ui.SnippetEditor"</code>).
	 */
	public static final String ID_SNIPPET_EDITOR= 		"org.summer.sdt.ui.SnippetEditor"; //$NON-NLS-1$

	/**
	 * The view part id of the Packages view
	 * (value <code>"org.summer.sdt.ui.PackageExplorer"</code>).
	 * <p>
	 ...
	 */
	public static final String ID_PACKAGES= 			"org.summer.sdt.ui.PackageExplorer"; //$NON-NLS-1$

	/**
	 * The view part id of the type hierarchy part
	 * (value <code>"org.summer.sdt.ui.TypeHierarchy"</code>).
	 * <p>
	 * When this id is used to access
	 * a view part with <code>IWorkbenchPage.findView</code> or
	 * <code>showView</code>, the returned <code>IViewPart</code>
	 ...
	 * @see org.eclipse.ui.IWorkbenchPage#showView(java.lang.String)
	 */
	public static final String ID_TYPE_HIERARCHY= 		"org.summer.sdt.ui.TypeHierarchy"; //$NON-NLS-1$

	/**
	 * The view part id of the source (declaration) view
	 * (value <code>"org.summer.sdt.ui.SourceView"</code>).
	 *
	 * @see org.eclipse.ui.IWorkbenchPage#findView(java.lang.String)
	 * @see org.eclipse.ui.IWorkbenchPage#showView(java.lang.String)
	 * @since 3.0
	 */
	public static final String ID_SOURCE_VIEW=	"org.summer.sdt.ui.SourceView"; //$NON-NLS-1$

	/**
	 * The view part id of the Javadoc view
	 * (value <code>"org.summer.sdt.ui.JavadocView"</code>).
	 *
	 * @see org.eclipse.ui.IWorkbenchPage#findView(java.lang.String)
	 * @see org.eclipse.ui.IWorkbenchPage#showView(java.lang.String)
	 * @since 3.0
	 */
	public static final String ID_JAVADOC_VIEW=	"org.summer.sdt.ui.JavadocView"; //$NON-NLS-1$

	/**
	 * The id of the Java Browsing Perspective
	 * (value <code>"org.summer.sdt.ui.JavaBrowsingPerspective"</code>).
	 *
	 * @since 2.0
	 */
	public static String ID_BROWSING_PERSPECTIVE= "org.summer.sdt.ui.JavaBrowsingPerspective"; //$NON-NLS-1$

	/**
	 * The view part id of the Java Browsing Projects view
	 * (value <code>"org.summer.sdt.ui.ProjectsView"</code>).
	 *
	 * @since 2.0
	 */
	public static String ID_PROJECTS_VIEW= "org.summer.sdt.ui.ProjectsView"; //$NON-NLS-1$

	/**
	 * The view part id of the Java Browsing Packages view
	 * (value <code>"org.summer.sdt.ui.PackagesView"</code>).
	 *
	 * @since 2.0
	 */
	public static String ID_PACKAGES_VIEW= "org.summer.sdt.ui.PackagesView"; //$NON-NLS-1$

	/**
	 * The view part id of the Java Browsing Types view
	 * (value <code>"org.summer.sdt.ui.TypesView"</code>).
	 *
	 * @since 2.0
	 */
	public static String ID_TYPES_VIEW= "org.summer.sdt.ui.TypesView"; //$NON-NLS-1$

	/**
	 * The view part id of the Java Browsing Members view
	 * (value <code>"org.summer.sdt.ui.MembersView"</code>).
	 *
	 * @since 2.0
	 */
	public static String ID_MEMBERS_VIEW= "org.summer.sdt.ui.MembersView"; //$NON-NLS-1$


	/**
	 * The preference page id of the user library preference page
	 * (value <code>"org.summer.sdt.ui.preferences.UserLibraryPreferencePage"</code>).
	 *
	 * @since 3.4
	 */
	public static final String ID_USER_LIBRARY_PREFERENCE_PAGE= "org.summer.sdt.ui.preferences.UserLibraryPreferencePage"; //$NON-NLS-1$

	/**
	 * The preference page id of the class path variables preference page
	 * (value <code>"org.summer.sdt.ui.preferences.ClasspathVariablesPreferencePage"</code>).
	 *
	 * @since 3.4
	 */
	public static final String ID_CLASSPATH_VARIABLES_PREFERENCE_PAGE= "org.summer.sdt.ui.preferences.ClasspathVariablesPreferencePage"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_CMDLINE= "org.summer.sdt.ui.launcher.cmdLine"; //$NON-NLS-1$
	 ...
	 *
	 * @see org.summer.sdt.core.JavaCore#getSharedWorkingCopies(org.summer.sdt.core.IBufferFactory)
	 * @since 2.0
	 * @deprecated Use {@link JavaCore#getWorkingCopies(org.summer.sdt.core.WorkingCopyOwner)} instead with <code>null</code> as
	 * argument for owner.
	 */
	public static org.summer.sdt.core.IWorkingCopy[] getSharedWorkingCopies() {
	 ...
	 * @since 2.1
	 * @deprecated Use {@link JavaCore#getWorkingCopies(org.summer.sdt.core.WorkingCopyOwner)} instead and filter the list
	 * with {@link IJavaProject#isOnClasspath(IJavaElement)}.
	 */
	public static org.summer.sdt.core.IWorkingCopy[] getSharedWorkingCopiesOnClasspath() {
		org.summer.sdt.core.IWorkingCopy[] wcs= getSharedWorkingCopies();
		List<org.summer.sdt.core.IWorkingCopy> result= new ArrayList<org.summer.sdt.core.IWorkingCopy>(wcs.length);
		for (int i = 0; i < wcs.length; i++) {
			org.summer.sdt.core.IWorkingCopy wc= wcs[i];
		...
		return result.toArray(new org.summer.sdt.core.IWorkingCopy[result.size()]);
	}
	 ...
	 *
	 * @see org.summer.sdt.core.IBufferFactory
	 * @since 2.0
	 * @deprecated {@link org.summer.sdt.core.IBufferFactory} has been replaced by {@link org.summer.sdt.core.WorkingCopyOwner}.
	 ...
	 */
	public static org.summer.sdt.core.IBufferFactory getBufferFactory() {
