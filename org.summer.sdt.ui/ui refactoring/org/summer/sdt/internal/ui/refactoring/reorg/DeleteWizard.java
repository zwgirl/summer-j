...
import org.summer.sdt.internal.ui.refactoring.MessageWizardPage;
...
public class DeleteWizard extends RefactoringWizard {
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.ui.refactoring.RefactoringWizard#addUserInputPages()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.ui.refactoring.RefactoringWizard#getMessageLineWidthInChars()
	 */
	@Override
	...
	private static class DeleteInputPage extends MessageWizardPage {
		...
		/* (non-Javadoc)
		 * @see org.summer.sdt.internal.ui.refactoring.RefactoringWizardPage#performFinish()
		 */
		@Override
