...
import org.summer.sdt.internal.compiler.classfmt.FieldInfo;
import org.summer.sdt.internal.compiler.classfmt.MethodInfo;
...
public class BinaryIndexer extends AbstractIndexer implements SuffixConstants {
	...
	private char[] removeFirstSyntheticParameter(char[] descriptor) {
		...
		if (descriptor[1] != ')') {
			...
			int start = org.summer.sdt.internal.compiler.util.Util.scanTypeSignature(descriptor, 1) + 1;
