...
import org.summer.sdt.core.dom.BindingResolver;
...
class DefaultValuePairBinding extends MemberValuePairBinding {
	...
	private org.summer.sdt.internal.compiler.lookup.MethodBinding method;

	DefaultValuePairBinding(org.summer.sdt.internal.compiler.lookup.MethodBinding binding, BindingResolver resolver) {
		super(null, resolver);
		this.method = binding;
