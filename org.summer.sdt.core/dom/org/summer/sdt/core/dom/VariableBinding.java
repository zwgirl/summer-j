...
class VariableBinding implements IVariableBinding {
	...
	VariableBinding(BindingResolver resolver, org.summer.sdt.internal.compiler.lookup.VariableBinding binding) {
	...
	public boolean isEqualTo(IBinding other) {
		...
		org.summer.sdt.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding) other).binding;
