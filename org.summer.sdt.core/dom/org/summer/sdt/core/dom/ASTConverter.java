...
import org.summer.sdt.core.dom.Modifier.ModifierKeyword;
...
import org.summer.sdt.internal.core.dom.SourceRangeVerifier;
...
class ASTConverter {
	...
	protected void adjustSourcePositionsForParent(org.summer.sdt.internal.compiler.ast.Expression expression) {
	...
	protected void buildBodyDeclarations(
		...
		org.summer.sdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = typeDeclaration.methods;
		...
		while ((fieldsIndex < fieldsLength)
			...
			org.summer.sdt.internal.compiler.ast.FieldDeclaration nextFieldDeclaration = null;
			org.summer.sdt.internal.compiler.ast.AbstractMethodDeclaration nextMethodDeclaration = null;
			org.summer.sdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = null;
	...
	protected void buildBodyDeclarations(org.summer.sdt.internal.compiler.ast.TypeDeclaration enumDeclaration2, EnumDeclaration enumDeclaration) {
		// add body declaration in the lexical order
		org.summer.sdt.internal.compiler.ast.TypeDeclaration[] members = enumDeclaration2.memberTypes;
		org.summer.sdt.internal.compiler.ast.FieldDeclaration[] fields = enumDeclaration2.fields;
		org.summer.sdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = enumDeclaration2.methods;
	...
	protected void buildBodyDeclarations(org.summer.sdt.internal.compiler.ast.TypeDeclaration expression, AnonymousClassDeclaration anonymousClassDeclaration) {
		// add body declaration in the lexical order
		org.summer.sdt.internal.compiler.ast.TypeDeclaration[] members = expression.memberTypes;
		org.summer.sdt.internal.compiler.ast.FieldDeclaration[] fields = expression.fields;
		org.summer.sdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = expression.methods;
	...
	protected void checkAndAddMultipleFieldDeclaration(org.summer.sdt.internal.compiler.ast.FieldDeclaration[] fields, int index, List bodyDeclarations) {
		if (fields[index] instanceof org.summer.sdt.internal.compiler.ast.Initializer) {
			org.summer.sdt.internal.compiler.ast.Initializer oldInitializer = (org.summer.sdt.internal.compiler.ast.Initializer) fields[index];
	...
	protected void checkAndAddMultipleLocalDeclaration(org.summer.sdt.internal.compiler.ast.Statement[] stmts, int index, List blockStatements) {
		if (index > 0
				&& stmts[index - 1] instanceof org.summer.sdt.internal.compiler.ast.LocalDeclaration) {
			org.summer.sdt.internal.compiler.ast.LocalDeclaration local1 = (org.summer.sdt.internal.compiler.ast.LocalDeclaration) stmts[index - 1];
			org.summer.sdt.internal.compiler.ast.LocalDeclaration local2 = (org.summer.sdt.internal.compiler.ast.LocalDeclaration) stmts[index];
			if (local1.declarationSourceStart == local2.declarationSourceStart) {
				...
				variableDeclarationStatement.fragments().add(convertToVariableDeclarationFragment((org.summer.sdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
			} else {
				// we can create a new FieldDeclaration
				blockStatements.add(convertToVariableDeclarationStatement((org.summer.sdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
			}
		} else {
			// we can create a new FieldDeclaration
			blockStatements.add(convertToVariableDeclarationStatement((org.summer.sdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
	...
	protected void completeRecord(ArrayType arrayType, org.summer.sdt.internal.compiler.ast.ASTNode astNode) {
	...
	public ASTNode convert(boolean isInterface, org.summer.sdt.internal.compiler.ast.AbstractMethodDeclaration methodDeclaration) {
		checkCanceled();
		if (methodDeclaration instanceof org.summer.sdt.internal.compiler.ast.AnnotationMethodDeclaration) {
			return convert((org.summer.sdt.internal.compiler.ast.AnnotationMethodDeclaration) methodDeclaration);
		}
		...
		org.summer.sdt.internal.compiler.ast.TypeReference[] thrownExceptions = methodDeclaration.thrownExceptions;
		...
		org.summer.sdt.internal.compiler.ast.Argument[] parameters = methodDeclaration.arguments;
		...
		org.summer.sdt.internal.compiler.ast.ExplicitConstructorCall explicitConstructorCall = null;
		if (isConstructor) {
			if (isInterface) {
				// interface cannot have a constructor
				methodDecl.setFlags(methodDecl.getFlags() | ASTNode.MALFORMED);
			}
			org.summer.sdt.internal.compiler.ast.ConstructorDeclaration constructorDeclaration = (org.summer.sdt.internal.compiler.ast.ConstructorDeclaration) methodDeclaration;
		...
		} else if (methodDeclaration instanceof org.summer.sdt.internal.compiler.ast.MethodDeclaration) {
			org.summer.sdt.internal.compiler.ast.MethodDeclaration method = (org.summer.sdt.internal.compiler.ast.MethodDeclaration) methodDeclaration;
			org.summer.sdt.internal.compiler.ast.TypeReference typeReference = method.returnType;
		...
		if (closingPosition != -1) {
			...
			org.summer.sdt.internal.compiler.ast.Statement[] statements = methodDeclaration.statements;
			...
			if (block != null && (statements != null || explicitConstructorCall != null)) {
				if (explicitConstructorCall != null && explicitConstructorCall.accessMode != org.summer.sdt.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper) {
					block.statements().add(convert(explicitConstructorCall));
				}
				int statementsLength = statements == null ? 0 : statements.length;
				for (int i = 0; i < statementsLength; i++) {
					if (statements[i] instanceof org.summer.sdt.internal.compiler.ast.LocalDeclaration) {
		...
		org.summer.sdt.internal.compiler.ast.TypeParameter[] typeParameters = methodDeclaration.typeParameters();
	...
	public ClassInstanceCreation convert(org.summer.sdt.internal.compiler.ast.AllocationExpression expression) {
		...
		org.summer.sdt.internal.compiler.ast.Expression[] arguments = expression.arguments;
		if (arguments != null) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.AND_AND_Expression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
		infixExpression.setOperator(InfixExpression.Operator.CONDITIONAL_AND);
		if (this.resolveBindings) {
			this.recordNodes(infixExpression, expression);
		}
		final int expressionOperatorID = (expression.bits & org.summer.sdt.internal.compiler.ast.ASTNode.OperatorMASK) >> org.summer.sdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
		if (expression.left instanceof org.summer.sdt.internal.compiler.ast.BinaryExpression
				&& ((expression.left.bits & org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)) {
			...
			org.summer.sdt.internal.compiler.ast.Expression leftOperand = expression.left;
			org.summer.sdt.internal.compiler.ast.Expression rightOperand = null;
			do {
				rightOperand = ((org.summer.sdt.internal.compiler.ast.BinaryExpression) leftOperand).right;
				if ((((leftOperand.bits & org.summer.sdt.internal.compiler.ast.ASTNode.OperatorMASK) >> org.summer.sdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID
							&& ((leftOperand.bits & org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
					 || ((rightOperand instanceof org.summer.sdt.internal.compiler.ast.BinaryExpression
				 			&& ((rightOperand.bits & org.summer.sdt.internal.compiler.ast.ASTNode.OperatorMASK) >> org.summer.sdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID)
							&& ((rightOperand.bits & org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))) {
				...
				leftOperand = ((org.summer.sdt.internal.compiler.ast.BinaryExpression) leftOperand).left;
			} while (leftOperand instanceof org.summer.sdt.internal.compiler.ast.BinaryExpression && ((leftOperand.bits & org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0));
	...
	private AnnotationTypeDeclaration convertToAnnotationDeclaration(org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		checkCanceled();
	...
	public ASTNode convert(org.summer.sdt.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration) {
		checkCanceled();
		...
		org.summer.sdt.internal.compiler.ast.TypeReference typeReference = annotationTypeMemberDeclaration.returnType;
		if (typeReference != null) {
			Type returnType = convertType(typeReference);
		...
		org.summer.sdt.internal.compiler.ast.Expression memberValue = annotationTypeMemberDeclaration.defaultValue;
		if (memberValue != null) {
	...
	public SingleVariableDeclaration convert(org.summer.sdt.internal.compiler.ast.Argument argument) {
	...
	public Annotation convert(org.summer.sdt.internal.compiler.ast.Annotation annotation) {
		if (annotation instanceof org.summer.sdt.internal.compiler.ast.SingleMemberAnnotation) {
			return convert((org.summer.sdt.internal.compiler.ast.SingleMemberAnnotation) annotation);
		} else if (annotation instanceof org.summer.sdt.internal.compiler.ast.MarkerAnnotation) {
			return convert((org.summer.sdt.internal.compiler.ast.MarkerAnnotation) annotation);
		} else {
			return convert((org.summer.sdt.internal.compiler.ast.NormalAnnotation) annotation);
		}
	}

	public ArrayCreation convert(org.summer.sdt.internal.compiler.ast.ArrayAllocationExpression expression) {
		...
		org.summer.sdt.internal.compiler.ast.Expression[] dimensions = expression.dimensions;
	...
	public ArrayInitializer convert(org.summer.sdt.internal.compiler.ast.ArrayInitializer expression) {
		...
		org.summer.sdt.internal.compiler.ast.Expression[] expressions = expression.expressions;
		if (expressions != null) {
	...
	public ArrayAccess convert(org.summer.sdt.internal.compiler.ast.ArrayReference reference) {
	...
	public AssertStatement convert(org.summer.sdt.internal.compiler.ast.AssertStatement statement) {
		...
		org.summer.sdt.internal.compiler.ast.Expression exceptionArgument = statement.exceptionArgument;
	...
	public Assignment convert(org.summer.sdt.internal.compiler.ast.Assignment expression) {
	 ...
	 */
	public TypeDeclaration convert(org.summer.sdt.internal.compiler.ast.ASTNode[] nodes) {
		...
		for (int i = 0; i < nodesLength; i++) {
			org.summer.sdt.internal.compiler.ast.ASTNode node = nodes[i];
			if (node instanceof org.summer.sdt.internal.compiler.ast.Initializer) {
				org.summer.sdt.internal.compiler.ast.Initializer oldInitializer = (org.summer.sdt.internal.compiler.ast.Initializer) node;
				Initializer initializer = new Initializer(this.ast);
				initializer.setBody(convert(oldInitializer.block));
				setModifiers(initializer, oldInitializer);
				initializer.setSourceRange(oldInitializer.declarationSourceStart, oldInitializer.sourceEnd - oldInitializer.declarationSourceStart + 1);
...
//				initializer.setJavadoc(convert(oldInitializer.javadoc));
			...
			} else if (node instanceof org.summer.sdt.internal.compiler.ast.FieldDeclaration) {
				org.summer.sdt.internal.compiler.ast.FieldDeclaration fieldDeclaration = (org.summer.sdt.internal.compiler.ast.FieldDeclaration) node;
				if (i > 0
					&& (nodes[i - 1] instanceof org.summer.sdt.internal.compiler.ast.FieldDeclaration)
					&& ((org.summer.sdt.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart == fieldDeclaration.declarationSourceStart) {
					// we have a multiple field declaration
					// We retrieve the existing fieldDeclaration to add the new VariableDeclarationFragment
			...
			} else if(node instanceof org.summer.sdt.internal.compiler.ast.AbstractMethodDeclaration) {
			...
			} else if(node instanceof org.summer.sdt.internal.compiler.ast.TypeDeclaration) {
				org.summer.sdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = (org.summer.sdt.internal.compiler.ast.TypeDeclaration) node;
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.BinaryExpression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
		if (this.resolveBindings) {
			this.recordNodes(infixExpression, expression);
		}

		int expressionOperatorID = (expression.bits & org.summer.sdt.internal.compiler.ast.ASTNode.OperatorMASK) >> org.summer.sdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
		...
		if (expression.left instanceof org.summer.sdt.internal.compiler.ast.BinaryExpression
			...
			final org.summer.sdt.internal.compiler.ast.Expression[] stringLiterals = literal.literals;
	...
	public Block convert(org.summer.sdt.internal.compiler.ast.Block statement) {
		Block block = new Block(this.ast);
		if (statement.sourceEnd > 0) {
			block.setSourceRange(statement.sourceStart, statement.sourceEnd - statement.sourceStart + 1);
		}
		org.summer.sdt.internal.compiler.ast.Statement[] statements = statement.statements;
		if (statements != null) {
	...
	public BreakStatement convert(org.summer.sdt.internal.compiler.ast.BreakStatement statement)  {
	...
	public SwitchCase convert(org.summer.sdt.internal.compiler.ast.CaseStatement statement) {
		SwitchCase switchCase = new SwitchCase(this.ast);
		org.summer.sdt.internal.compiler.ast.Expression constantExpression = statement.constantExpression;
	...
	public CastExpression convert(org.summer.sdt.internal.compiler.ast.CastExpression expression) {
	...
	public CharacterLiteral convert(org.summer.sdt.internal.compiler.ast.CharLiteral expression) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.ClassLiteralAccess expression) {
	...
	public Assignment convert(org.summer.sdt.internal.compiler.ast.CompoundAssignment expression) {
		Assignment assignment = new Assignment(this.ast);
		Expression lhs = convert(expression.lhs);
		assignment.setLeftHandSide(lhs);
		int start = lhs.getStartPosition();
	...
	public ConditionalExpression convert(org.summer.sdt.internal.compiler.ast.ConditionalExpression expression) {
	...
	public ContinueStatement convert(org.summer.sdt.internal.compiler.ast.ContinueStatement statement)  {
	...
	public DoStatement convert(org.summer.sdt.internal.compiler.ast.DoStatement statement) {
	...
	public NumberLiteral convert(org.summer.sdt.internal.compiler.ast.DoubleLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;
		int sourceStart = expression.sourceStart;
	...
	public EmptyStatement convert(org.summer.sdt.internal.compiler.ast.EmptyStatement statement) {
	...
	public EnumConstantDeclaration convert(org.summer.sdt.internal.compiler.ast.FieldDeclaration enumConstant) {
		checkCanceled();
		...
		final org.summer.sdt.internal.compiler.ast.Expression initialization = enumConstant.initialization;
		if (initialization != null) {
			if (initialization instanceof QualifiedAllocationExpression) {
				org.summer.sdt.internal.compiler.ast.TypeDeclaration anonymousType = ((QualifiedAllocationExpression) initialization).anonymousType;
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.EqualExpression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
		if (this.resolveBindings) {
	...
	public Statement convert(org.summer.sdt.internal.compiler.ast.ExplicitConstructorCall statement) {
		...
		if (statement.isSuperAccess() || statement.isSuper()) {
			...
			org.summer.sdt.internal.compiler.ast.Expression[] arguments = statement.arguments;
			if (arguments != null) {
				int length = arguments.length;
				for (int i = 0; i < length; i++) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.Expression expression) {
		if ((expression.bits & org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
			return convertToParenthesizedExpression(expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.Annotation) {
			return convert((org.summer.sdt.internal.compiler.ast.Annotation) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.CastExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.CastExpression) expression);
		}
		// switch between all types of expression
		if (expression instanceof org.summer.sdt.internal.compiler.ast.ArrayAllocationExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.ArrayAllocationExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.QualifiedAllocationExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.QualifiedAllocationExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.AllocationExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.AllocationExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.ArrayInitializer) {
			return convert((org.summer.sdt.internal.compiler.ast.ArrayInitializer) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.PrefixExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.PrefixExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.PostfixExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.PostfixExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.CompoundAssignment) {
			return convert((org.summer.sdt.internal.compiler.ast.CompoundAssignment) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.Assignment) {
			return convert((org.summer.sdt.internal.compiler.ast.Assignment) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.ClassLiteralAccess) {
			return convert((org.summer.sdt.internal.compiler.ast.ClassLiteralAccess) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.FalseLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.FalseLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.TrueLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.TrueLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.NullLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.NullLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.CharLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.CharLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.DoubleLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.DoubleLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.FloatLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.FloatLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.IntLiteralMinValue) {
			return convert((org.summer.sdt.internal.compiler.ast.IntLiteralMinValue) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.IntLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.IntLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.LongLiteralMinValue) {
			return convert((org.summer.sdt.internal.compiler.ast.LongLiteralMinValue) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.LongLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.LongLiteral) expression);
		}
		if (expression instanceof StringLiteralConcatenation) {
			return convert((StringLiteralConcatenation) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.ExtendedStringLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.ExtendedStringLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.StringLiteral) {
			return convert((org.summer.sdt.internal.compiler.ast.StringLiteral) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.AND_AND_Expression) {
			return convert((org.summer.sdt.internal.compiler.ast.AND_AND_Expression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.OR_OR_Expression) {
			return convert((org.summer.sdt.internal.compiler.ast.OR_OR_Expression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.EqualExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.EqualExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.BinaryExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.BinaryExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.InstanceOfExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.InstanceOfExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.UnaryExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.UnaryExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.ConditionalExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.ConditionalExpression) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.MessageSend) {
			return convert((org.summer.sdt.internal.compiler.ast.MessageSend) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.Reference) {
			return convert((org.summer.sdt.internal.compiler.ast.Reference) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.TypeReference) {
			return convert((org.summer.sdt.internal.compiler.ast.TypeReference) expression);
		}
		if (expression instanceof org.summer.sdt.internal.compiler.ast.LambdaExpression) {
			return convert((org.summer.sdt.internal.compiler.ast.LambdaExpression) expression);
		}
	...
	public StringLiteral convert(org.summer.sdt.internal.compiler.ast.ExtendedStringLiteral expression) {
	...
	public BooleanLiteral convert(org.summer.sdt.internal.compiler.ast.FalseLiteral expression) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.FieldReference reference) {
		if (reference.receiver.isSuper()) {
			...
			if (reference.receiver instanceof org.summer.sdt.internal.compiler.ast.QualifiedSuperReference) {
				Name qualifier = convert((org.summer.sdt.internal.compiler.ast.QualifiedSuperReference) reference.receiver);
	...
	public NumberLiteral convert(org.summer.sdt.internal.compiler.ast.FloatLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;
		int sourceStart = expression.sourceStart;
		NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
	...
	public Statement convert(ForeachStatement statement) {
		switch(this.ast.apiLevel) {
			...
			default :
				...
				org.summer.sdt.internal.compiler.ast.Expression collection = statement.collection;
	...
	public ForStatement convert(org.summer.sdt.internal.compiler.ast.ForStatement statement) {
		...
		org.summer.sdt.internal.compiler.ast.Statement[] initializations = statement.initializations;
		if (initializations != null) {
			// we know that we have at least one initialization
			if (initializations[0] instanceof org.summer.sdt.internal.compiler.ast.LocalDeclaration) {
				org.summer.sdt.internal.compiler.ast.LocalDeclaration initialization = (org.summer.sdt.internal.compiler.ast.LocalDeclaration) initializations[0];
				...
				for (int i = 1; i < initializationsLength; i++) {
					initialization = (org.summer.sdt.internal.compiler.ast.LocalDeclaration)initializations[i];
				...
				if (initializationsLength != 1) {
					...
					int end = ((org.summer.sdt.internal.compiler.ast.LocalDeclaration) initializations[initializationsLength - 1]).declarationSourceEnd;
		...
		org.summer.sdt.internal.compiler.ast.Statement[] increments = statement.increments;
		if (increments != null) {
	...
	public IfStatement convert(org.summer.sdt.internal.compiler.ast.IfStatement statement) {
		...
		org.summer.sdt.internal.compiler.ast.Statement statement2 = statement.elseStatement;
		if (statement2 != null) {
	...
	public InstanceofExpression convert(org.summer.sdt.internal.compiler.ast.InstanceOfExpression expression) {
	...
	public NumberLiteral convert(org.summer.sdt.internal.compiler.ast.IntLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;
		int sourceStart = expression.sourceStart;
	...
	public NumberLiteral convert(org.summer.sdt.internal.compiler.ast.IntLiteralMinValue expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;
		int sourceStart = expression.sourceStart;
		NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
	...
	public void convert(org.summer.sdt.internal.compiler.ast.Javadoc javadoc, BodyDeclaration bodyDeclaration) {
	...
	public void convert(org.summer.sdt.internal.compiler.ast.Javadoc javadoc, PackageDeclaration packageDeclaration) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL :
				return;
		}
	...
	public LabeledStatement convert(org.summer.sdt.internal.compiler.ast.LabeledStatement statement) {
	...
	public NumberLiteral convert(org.summer.sdt.internal.compiler.ast.LongLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;
		int sourceStart = expression.sourceStart;
		final NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
	...
	public NumberLiteral convert(org.summer.sdt.internal.compiler.ast.LongLiteralMinValue expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;
		int sourceStart = expression.sourceStart;
		final NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
	...
	public Expression convert(MessageSend expression) {
		...
		if (expression.isSuperAccess()) {
			...
			if (expression.receiver instanceof org.summer.sdt.internal.compiler.ast.QualifiedSuperReference) {
				Name qualifier = convert((org.summer.sdt.internal.compiler.ast.QualifiedSuperReference) expression.receiver);
			...
			org.summer.sdt.internal.compiler.ast.Expression receiver = expression.receiver;
			if (receiver instanceof MessageSend) {
				if ((receiver.bits & org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.LambdaExpression lambda) {
		if (this.ast.apiLevel < AST.JLS8) {
		...
		org.summer.sdt.internal.compiler.ast.Argument[] arguments = lambda.arguments();
		if (arguments != null) {
			int argumentsLength = arguments.length;
			for (int i = 0; i < argumentsLength; i++) {
				org.summer.sdt.internal.compiler.ast.Argument argument = arguments[i];
		...
		final org.summer.sdt.internal.compiler.ast.Statement body = lambda.body();
		if (body instanceof org.summer.sdt.internal.compiler.ast.Expression) {
			lambdaExpression.setBody(convert((org.summer.sdt.internal.compiler.ast.Expression) body));
		} else {
			lambdaExpression.setBody(convert((org.summer.sdt.internal.compiler.ast.Block) body));
		}
	...
	public MarkerAnnotation convert(org.summer.sdt.internal.compiler.ast.MarkerAnnotation annotation) {
	...
	public MemberValuePair convert(org.summer.sdt.internal.compiler.ast.MemberValuePair memberValuePair) {
	...
	public Name convert(org.summer.sdt.internal.compiler.ast.NameReference reference) {
		if (reference instanceof org.summer.sdt.internal.compiler.ast.QualifiedNameReference) {
			return convert((org.summer.sdt.internal.compiler.ast.QualifiedNameReference) reference);
		} else {
			return convert((org.summer.sdt.internal.compiler.ast.SingleNameReference) reference);
		}
	}
	...
	public InfixExpression convert(StringLiteralConcatenation expression) {
		...
		org.summer.sdt.internal.compiler.ast.Expression[] stringLiterals = expression.literals;
		infixExpression.setLeftOperand(convert(stringLiterals[0]));
		infixExpression.setRightOperand(convert(stringLiterals[1]));
	...
	public NormalAnnotation convert(org.summer.sdt.internal.compiler.ast.NormalAnnotation annotation) {
		...
		org.summer.sdt.internal.compiler.ast.MemberValuePair[] memberValuePairs = annotation.memberValuePairs;
	...
	public NullLiteral convert(org.summer.sdt.internal.compiler.ast.NullLiteral expression) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.OR_OR_Expression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
	...
	public PostfixExpression convert(org.summer.sdt.internal.compiler.ast.PostfixExpression expression) {
	...
	public PrefixExpression convert(org.summer.sdt.internal.compiler.ast.PrefixExpression expression) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.QualifiedAllocationExpression allocation) {
		...
		org.summer.sdt.internal.compiler.ast.Expression[] arguments = allocation.arguments;
		if (arguments != null) {
			int length = arguments.length;
			for (int i = 0; i < length; i++) {
	...
	public Name convert(org.summer.sdt.internal.compiler.ast.QualifiedNameReference nameReference) {
		return setQualifiedNameNameAndSourceRanges(nameReference.tokens, nameReference.sourcePositions, nameReference);
	}

	public Name convert(org.summer.sdt.internal.compiler.ast.QualifiedSuperReference reference) {
		return convert(reference.qualification);
	}

	public ThisExpression convert(org.summer.sdt.internal.compiler.ast.QualifiedThisReference reference) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.Reference reference) {
		if (reference instanceof org.summer.sdt.internal.compiler.ast.NameReference) {
			return convert((org.summer.sdt.internal.compiler.ast.NameReference) reference);
		}
		if (reference instanceof org.summer.sdt.internal.compiler.ast.ThisReference) {
			return convert((org.summer.sdt.internal.compiler.ast.ThisReference) reference);
		}
		if (reference instanceof org.summer.sdt.internal.compiler.ast.ArrayReference) {
			return convert((org.summer.sdt.internal.compiler.ast.ArrayReference) reference);
		}
		if (reference instanceof org.summer.sdt.internal.compiler.ast.FieldReference) {
			return convert((org.summer.sdt.internal.compiler.ast.FieldReference) reference);
		}
		return null; // cannot be reached
	}

	public Expression convert(org.summer.sdt.internal.compiler.ast.ReferenceExpression reference) {
		if (this.ast.apiLevel < AST.JLS8) {
			return createFakeNullLiteral(reference);
		}
		Expression result = null;
		org.summer.sdt.internal.compiler.ast.Expression lhs = reference.lhs;
		org.summer.sdt.internal.compiler.ast.TypeReference[] arguments = reference.typeArguments;
		...
		if (typeArguments != null && arguments != null) {
			int argumentsLength = arguments.length;
			for (int i = 0; i < argumentsLength; i++) {
				org.summer.sdt.internal.compiler.ast.TypeReference argument = arguments[i];
	...
	public ReturnStatement convert(org.summer.sdt.internal.compiler.ast.ReturnStatement statement) {
	...
	public SingleMemberAnnotation convert(org.summer.sdt.internal.compiler.ast.SingleMemberAnnotation annotation) {
	...
	public SimpleName convert(org.summer.sdt.internal.compiler.ast.SingleNameReference nameReference) {
		final SimpleName name = new SimpleName(this.ast);
	...
	public Statement convert(org.summer.sdt.internal.compiler.ast.Statement statement) {
		if (statement instanceof ForeachStatement) {
			return convert((ForeachStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.LocalDeclaration) {
			org.summer.sdt.internal.compiler.ast.LocalDeclaration localDeclaration = (org.summer.sdt.internal.compiler.ast.LocalDeclaration)statement;
			return convertToVariableDeclarationStatement(localDeclaration);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.AssertStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.AssertStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.Block) {
			return convert((org.summer.sdt.internal.compiler.ast.Block) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.BreakStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.BreakStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.ContinueStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.ContinueStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.CaseStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.CaseStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.DoStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.DoStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.EmptyStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.EmptyStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.ExplicitConstructorCall) {
			return convert((org.summer.sdt.internal.compiler.ast.ExplicitConstructorCall) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.ForStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.ForStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.IfStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.IfStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.LabeledStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.LabeledStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.ReturnStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.ReturnStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.SwitchStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.SwitchStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.SynchronizedStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.SynchronizedStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.ThrowStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.ThrowStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.TryStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.TryStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.TypeDeclaration) {
			ASTNode result = convert((org.summer.sdt.internal.compiler.ast.TypeDeclaration) statement);
		...
		if (statement instanceof org.summer.sdt.internal.compiler.ast.WhileStatement) {
			return convert((org.summer.sdt.internal.compiler.ast.WhileStatement) statement);
		}
		if (statement instanceof org.summer.sdt.internal.compiler.ast.Expression) {
			org.summer.sdt.internal.compiler.ast.Expression statement2 = (org.summer.sdt.internal.compiler.ast.Expression) statement;
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.StringLiteral expression) {
		if (expression instanceof StringLiteralConcatenation) {
			return convert((StringLiteralConcatenation) expression);
		}
		int length = expression.sourceEnd - expression.sourceStart + 1;
	...
	public SwitchStatement convert(org.summer.sdt.internal.compiler.ast.SwitchStatement statement) {
	...
	public SynchronizedStatement convert(org.summer.sdt.internal.compiler.ast.SynchronizedStatement statement) {
	...
	public Expression convert(org.summer.sdt.internal.compiler.ast.ThisReference reference) {
		if (reference.isImplicitThis()) {
			// There is no source associated with an implicit this
			return null;
		} else if (reference instanceof org.summer.sdt.internal.compiler.ast.QualifiedSuperReference) {
			return convert((org.summer.sdt.internal.compiler.ast.QualifiedSuperReference) reference);
		} else if (reference instanceof org.summer.sdt.internal.compiler.ast.QualifiedThisReference) {
			return convert((org.summer.sdt.internal.compiler.ast.QualifiedThisReference) reference);
		}  else {
	...
	public ThrowStatement convert(org.summer.sdt.internal.compiler.ast.ThrowStatement statement) {
	...
	public BooleanLiteral convert(org.summer.sdt.internal.compiler.ast.TrueLiteral expression) {
		final BooleanLiteral literal = new BooleanLiteral(this.ast);
	...
	public TryStatement convert(org.summer.sdt.internal.compiler.ast.TryStatement statement) {
		...
		org.summer.sdt.internal.compiler.ast.Argument[] catchArguments = statement.catchArguments;
		if (catchArguments != null) {
			int catchArgumentsLength = catchArguments.length;
			org.summer.sdt.internal.compiler.ast.Block[] catchBlocks = statement.catchBlocks;
	...
	public ASTNode convert(org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		int kind = org.summer.sdt.internal.compiler.ast.TypeDeclaration.kind(typeDeclaration.modifiers);
		switch (kind) {
		...
		boolean isInterface = kind == org.summer.sdt.internal.compiler.ast.TypeDeclaration.INTERFACE_DECL;
		...
		org.summer.sdt.internal.compiler.ast.TypeReference[] superInterfaces = typeDeclaration.superInterfaces;
		...
		org.summer.sdt.internal.compiler.ast.TypeParameter[] typeParameters = typeDeclaration.typeParameters;
		if (typeParameters != null) {
			switch(this.ast.apiLevel) {
				case AST.JLS2_INTERNAL :
					typeDecl.setFlags(typeDecl.getFlags() | ASTNode.MALFORMED);
	...
	public TypeParameter convert(org.summer.sdt.internal.compiler.ast.TypeParameter typeParameter) {
		...
		org.summer.sdt.internal.compiler.ast.Annotation[] annotations = typeParameter.annotations;
		if (annotations != null) {
	...
	public Name convert(org.summer.sdt.internal.compiler.ast.TypeReference typeReference) {
		char[][] typeName = typeReference.getTypeName();
		int length = typeName.length;
		if (length > 1) {
			// QualifiedName
			org.summer.sdt.internal.compiler.ast.QualifiedTypeReference qualifiedTypeReference = (org.summer.sdt.internal.compiler.ast.QualifiedTypeReference) typeReference;
	...
	public PrefixExpression convert(org.summer.sdt.internal.compiler.ast.UnaryExpression expression) {
		final PrefixExpression prefixExpression = new PrefixExpression(this.ast);
		if (this.resolveBindings) {
	...
	public WhileStatement convert(org.summer.sdt.internal.compiler.ast.WhileStatement statement) {
...
//				xamlElement.children().add(convert((org.summer.sdt.internal.compiler.ast.PCDATA)child));
	...
	public ImportDeclaration convertImport(org.summer.sdt.internal.compiler.ast.ImportReference importReference) {
		...
		final boolean onDemand = (importReference.bits & org.summer.sdt.internal.compiler.ast.ASTNode.OnDemand) != 0;
	...
	public PackageDeclaration convertPackage(org.summer.sdt.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration) {
		org.summer.sdt.internal.compiler.ast.ImportReference importReference = compilationUnitDeclaration.currentPackage;
		...
		org.summer.sdt.internal.compiler.ast.Annotation[] annotations = importReference.annotations;
		if (annotations != null) {
			switch(this.ast.apiLevel) {
				case AST.JLS2_INTERNAL :
	...
	private ArrayType convertToArray(Type elementType, int sourceStart, int length, int dimensions, org.summer.sdt.internal.compiler.ast.Annotation[][] annotationsOnDimensions) {
	...
	private EnumDeclaration convertToEnumDeclaration(org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		checkCanceled();
	...
	public Expression convertToExpression(org.summer.sdt.internal.compiler.ast.Statement statement) {
		if (statement instanceof org.summer.sdt.internal.compiler.ast.Expression) {
			return convert((org.summer.sdt.internal.compiler.ast.Expression) statement);
		} else {
			return null;
		}
	}

	protected FieldDeclaration convertToFieldDeclaration(org.summer.sdt.internal.compiler.ast.FieldDeclaration fieldDecl) {
	...
	public ParenthesizedExpression convertToParenthesizedExpression(org.summer.sdt.internal.compiler.ast.Expression expression) {
		...
		int numberOfParenthesis = (expression.bits & org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) >> org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
		expression.bits &= ~org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedMASK;
		expression.bits |= (numberOfParenthesis - 1) << org.summer.sdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
		parenthesizedExpression.setExpression(convert(expression));
		return parenthesizedExpression;
	}

	protected VariableDeclarationExpression convertToVariableDeclarationExpression(org.summer.sdt.internal.compiler.ast.LocalDeclaration localDeclaration) {
	...
	protected SingleVariableDeclaration convertToSingleVariableDeclaration(LocalDeclaration localDeclaration) {
		...
		int sourceEnd = ((localDeclaration.bits & org.summer.sdt.internal.compiler.ast.ASTNode.IsForeachElementVariable) != 0)  
	...
	private Dimension convertToDimensions(int start, int end, org.summer.sdt.internal.compiler.ast.Annotation[] annotation) {
	...
	protected VariableDeclarationFragment convertToVariableDeclarationFragment(org.summer.sdt.internal.compiler.ast.FieldDeclaration fieldDeclaration) {
	...
	protected VariableDeclarationFragment convertToVariableDeclarationFragment(org.summer.sdt.internal.compiler.ast.LocalDeclaration localDeclaration) {
		final VariableDeclarationFragment variableDeclarationFragment = new VariableDeclarationFragment(this.ast);
		final SimpleName name = new SimpleName(this.ast);
		name.internalSetIdentifier(new String(localDeclaration.name));
		...
		org.summer.sdt.internal.compiler.ast.Expression initialization = localDeclaration.initialization;
		TypeReference typeReference = localDeclaration.type;
	...
	protected void setExtraAnnotatedDimensions(int start, int end, TypeReference type, final List extraAnnotatedDimensions, int extraDimension) {
		if (extraDimension > 0) {
			org.summer.sdt.internal.compiler.ast.Annotation[][] annotationsOnDims = type.getAnnotationsOnDimensions(true);
	...
	private void setTypeAnnotationsOnDimension(Dimension currentDimension, org.summer.sdt.internal.compiler.ast.Annotation[][] annotationsOnDimensions, int dimension) {
		if (annotationsOnDimensions == null) return;
		org.summer.sdt.internal.compiler.ast.Annotation[] annotations = annotationsOnDimensions[dimension];
		if (annotations != null) {
	...
	private void setTypeAnnotationsAndSourceRangeOnArray(ArrayType arrayType, org.summer.sdt.internal.compiler.ast.Annotation[][] annotationsOnDimensions) {
	...
	protected VariableDeclarationStatement convertToVariableDeclarationStatement(org.summer.sdt.internal.compiler.ast.LocalDeclaration localDeclaration) {
		final VariableDeclarationFragment variableDeclarationFragment = convertToVariableDeclarationFragment(localDeclaration);
	...
	private int annotateType(AnnotatableType type, org.summer.sdt.internal.compiler.ast.Annotation[] annotations) {
		...
		switch(this.ast.apiLevel) {
			...
			default:
				...
				for (int i = 0; i < annotationsLength; i++) {
					org.summer.sdt.internal.compiler.ast.Annotation typeAnnotation = annotations[i];
	...
	private void annotateTypeParameter(TypeParameter typeParameter, org.summer.sdt.internal.compiler.ast.Annotation[] annotations) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL :
			case AST.JLS3_INTERNAL :
			case AST.JLS4_INTERNAL:
	...
	public Type convertType(TypeReference typeReference) {
		org.summer.sdt.internal.compiler.ast.Annotation[] annotations;
		...
		if (typeReference instanceof org.summer.sdt.internal.compiler.ast.SingleTypeReference) {
			...
			char[] name = ((org.summer.sdt.internal.compiler.ast.SingleTypeReference) typeReference).getTypeName()[0];
			...
			if (typeReference instanceof ParameterizedQualifiedTypeReference) {
				...
				org.summer.sdt.internal.compiler.ast.Annotation[][] typeAnnotations = parameterizedQualifiedTypeReference.annotations;
				...
				switch(this.ast.apiLevel) {
					case AST.JLS2_INTERNAL : {
						char[][] name = ((org.summer.sdt.internal.compiler.ast.QualifiedTypeReference) typeReference).getTypeName();
			...
			} else if (typeReference instanceof org.summer.sdt.internal.compiler.ast.QualifiedTypeReference) {			
				QualifiedTypeReference qualifiedTypeReference = (QualifiedTypeReference) typeReference;
				long[] positions = ((org.summer.sdt.internal.compiler.ast.QualifiedTypeReference) typeReference).sourcePositions;
				org.summer.sdt.internal.compiler.ast.Annotation [][] typeAnnotations = typeReference.annotations;
				...
				TypeReference[] typeReferences = ((org.summer.sdt.internal.compiler.ast.UnionTypeReference) typeReference).typeReferences;
				switch(this.ast.apiLevel) {
					case AST.JLS2_INTERNAL :
					case AST.JLS3_INTERNAL :
						// recovery
	...
	private QualifiedType createQualifiedType(TypeReference typeReference, long[] positions,
			org.summer.sdt.internal.compiler.ast.Annotation[][] typeAnnotations, char[][] tokens, int index,
			Type qualifier) {
	...
	private void setSourceRangeAnnotationsAndRecordNodes(TypeReference typeReference, AnnotatableType annotatableType,
			org.summer.sdt.internal.compiler.ast.Annotation[][] typeAnnotations, int index, int start, int end) {
		org.summer.sdt.internal.compiler.ast.Annotation[] annotations;
	...
	private void setSourceRangeAnnotationsAndRecordNodes(TypeReference typeReference, AnnotatableType annotatableType, 
			long[] positions, org.summer.sdt.internal.compiler.ast.Annotation[][] typeAnnotations, int index, int startIndex, int endIndex) {
		int start = (int) (positions[startIndex] >>> 32);
		int end = (int) positions[endIndex];
	...
	protected Statement createFakeEmptyStatement(org.summer.sdt.internal.compiler.ast.Statement statement) {
	 ...
	 * {@link #recordNodes(ASTNode, org.summer.sdt.internal.compiler.ast.ASTNode)}, see bug 403444!
	 */
	protected Expression createFakeNullLiteral(org.summer.sdt.internal.compiler.ast.FunctionalExpression expression) {
	...
	private BlockScope lookupScope(ASTNode node) {
		...
		if (currentNode instanceof Initializer) {
			...
			if (currentNode instanceof TypeDeclaration
				...
				org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDecl = (org.summer.sdt.internal.compiler.ast.TypeDeclaration) this.ast.getBindingResolver().getCorrespondingNode(currentNode);
	...
	protected void recordName(Name name, org.summer.sdt.internal.compiler.ast.ASTNode compilerNode) {
		if (compilerNode != null) {
			recordNodes(name, compilerNode);
			if (compilerNode instanceof org.summer.sdt.internal.compiler.ast.TypeReference) {
				org.summer.sdt.internal.compiler.ast.TypeReference typeRef = (org.summer.sdt.internal.compiler.ast.TypeReference) compilerNode;
	...
	protected void recordNodes(ASTNode node, org.summer.sdt.internal.compiler.ast.ASTNode oldASTNode) {
		...
		if (oldASTNode instanceof org.summer.sdt.internal.compiler.ast.FunctionalExpression && node instanceof NullLiteral) {
			return;
		}
		this.ast.getBindingResolver().store(node, oldASTNode);
	}

	protected void recordNodes(org.summer.sdt.internal.compiler.ast.Javadoc javadoc, TagElement tagElement) {
		...
		while (fragments.hasNext()) {
			...
			if (node.getNodeType() == ASTNode.MEMBER_REF) {
				...
				org.summer.sdt.internal.compiler.ast.ASTNode compilerNode = javadoc.getNodeStartingAt(start);
				if (compilerNode!= null) {
					recordNodes(name, compilerNode);
				...
				if (memberRef.getQualifier() != null) {
					org.summer.sdt.internal.compiler.ast.TypeReference typeRef = null;
					if (compilerNode instanceof JavadocFieldReference) {
						org.summer.sdt.internal.compiler.ast.Expression expression = ((JavadocFieldReference)compilerNode).receiver;
						if (expression instanceof org.summer.sdt.internal.compiler.ast.TypeReference) {
							typeRef = (org.summer.sdt.internal.compiler.ast.TypeReference) expression;
						}
					}
					else if (compilerNode instanceof JavadocMessageSend) {
						org.summer.sdt.internal.compiler.ast.Expression expression = ((JavadocMessageSend)compilerNode).receiver;
						if (expression instanceof org.summer.sdt.internal.compiler.ast.TypeReference) {
							typeRef = (org.summer.sdt.internal.compiler.ast.TypeReference) expression;
						}
					}
				...
				if (compilerNode != null) {
					...
					// get type ref
					org.summer.sdt.internal.compiler.ast.TypeReference typeRef = null;
					if (compilerNode instanceof org.summer.sdt.internal.compiler.ast.JavadocAllocationExpression) {
						typeRef = ((org.summer.sdt.internal.compiler.ast.JavadocAllocationExpression)compilerNode).type;
						if (typeRef != null) recordNodes(name, compilerNode);
					}
					else if (compilerNode instanceof org.summer.sdt.internal.compiler.ast.JavadocMessageSend) {
						org.summer.sdt.internal.compiler.ast.Expression expression = ((org.summer.sdt.internal.compiler.ast.JavadocMessageSend)compilerNode).receiver;
						if (expression instanceof org.summer.sdt.internal.compiler.ast.TypeReference) {
							typeRef = (org.summer.sdt.internal.compiler.ast.TypeReference) expression;
						}
						recordNodes(name, compilerNode);
				...
				while (parameters.hasNext()) {
					...
					org.summer.sdt.internal.compiler.ast.Expression expression = (org.summer.sdt.internal.compiler.ast.Expression) javadoc.getNodeStartingAt(param.getStartPosition());
					if (expression != null) {
						...
						if (expression instanceof JavadocArgumentExpression) {
							...
							org.summer.sdt.internal.compiler.ast.TypeReference typeRef = argExpr.argument.type;
				...
				org.summer.sdt.internal.compiler.ast.ASTNode compilerNode = javadoc.getNodeStartingAt(node.getStartPosition());
	 ...
	 */
	private void trimWhiteSpacesAndComments(org.summer.sdt.internal.compiler.ast.Expression expression) {
	...
	protected void setModifiers(AnnotationTypeDeclaration typeDecl, org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
	...
	protected void setModifiers(AnnotationTypeMemberDeclaration annotationTypeMemberDecl, org.summer.sdt.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration) {
	 ...
	 */
	protected void setModifiers(BodyDeclaration bodyDeclaration, org.summer.sdt.internal.compiler.ast.Annotation[] annotations, int modifiersEnd) {
				...
				switch(token) {
					...
					case TerminalTokens.TokenNameAT :
						...
						if (annotations != null && indexInAnnotations < annotations.length) {
							org.summer.sdt.internal.compiler.ast.Annotation annotation = annotations[indexInAnnotations++];
	...
	protected void setModifiers(EnumDeclaration enumDeclaration, org.summer.sdt.internal.compiler.ast.TypeDeclaration enumDeclaration2) {
	...
	protected void setModifiers(EnumConstantDeclaration enumConstantDeclaration, org.summer.sdt.internal.compiler.ast.FieldDeclaration fieldDeclaration) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL :
	 ...
	 * @param fieldDecl
	 */
	protected void setModifiers(FieldDeclaration fieldDeclaration, org.summer.sdt.internal.compiler.ast.FieldDeclaration fieldDecl) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL :
	 ...
	 */
	protected void setModifiers(Initializer initializer, org.summer.sdt.internal.compiler.ast.Initializer oldInitializer) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL:
	...
	protected void setModifiers(SingleVariableDeclaration variableDecl, Argument argument) {
		switch(this.ast.apiLevel) {
			...
			default :
				...
				org.summer.sdt.internal.compiler.ast.Annotation[] annotations = argument.annotations;
				int indexInAnnotations = 0;
				try {
					int token;
					while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF) {
	...
	protected void setModifiers(SingleVariableDeclaration variableDecl, LocalDeclaration localDeclaration) {
		...
		default :
			...
			org.summer.sdt.internal.compiler.ast.Annotation[] annotations = localDeclaration.annotations;
			int indexInAnnotations = 0;
			try {
				int token;
				while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF) {
	 ...
	 */
	protected void setModifiers(TypeDeclaration typeDecl, org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL :
	...
	protected QualifiedName setQualifiedNameNameAndSourceRanges(char[][] typeName, long[] positions, org.summer.sdt.internal.compiler.ast.ASTNode node) {
	    int length = typeName.length;
	...
	protected QualifiedName setQualifiedNameNameAndSourceRanges(char[][] typeName, long[] positions, int endingIndex, org.summer.sdt.internal.compiler.ast.TypeReference node) {
	...
	protected void setTypeNameForAnnotation(org.summer.sdt.internal.compiler.ast.Annotation compilerAnnotation, Annotation annotation) {
