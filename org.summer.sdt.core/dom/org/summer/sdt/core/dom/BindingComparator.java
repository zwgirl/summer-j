...
class BindingComparator {
	...
	static boolean isEqual(Binding declaringElement, Binding declaringElement2, HashSet visitedTypes) {
		if (declaringElement instanceof org.summer.sdt.internal.compiler.lookup.TypeBinding) {
			if (!(declaringElement2 instanceof org.summer.sdt.internal.compiler.lookup.TypeBinding)){
				return false;
			}
			return isEqual((org.summer.sdt.internal.compiler.lookup.TypeBinding) declaringElement,
					(org.summer.sdt.internal.compiler.lookup.TypeBinding) declaringElement2,
					visitedTypes);
		} else if (declaringElement instanceof org.summer.sdt.internal.compiler.lookup.MethodBinding) {
			if (!(declaringElement2 instanceof org.summer.sdt.internal.compiler.lookup.MethodBinding)) {
				return false;
			}
			return isEqual((org.summer.sdt.internal.compiler.lookup.MethodBinding) declaringElement,
					(org.summer.sdt.internal.compiler.lookup.MethodBinding) declaringElement2,
					visitedTypes);
		...
		} else if (declaringElement instanceof org.summer.sdt.internal.compiler.lookup.PackageBinding) {
			if (!(declaringElement2 instanceof org.summer.sdt.internal.compiler.lookup.PackageBinding)) {
				return false;
			}
			org.summer.sdt.internal.compiler.lookup.PackageBinding packageBinding = (org.summer.sdt.internal.compiler.lookup.PackageBinding) declaringElement;
			org.summer.sdt.internal.compiler.lookup.PackageBinding packageBinding2 = (org.summer.sdt.internal.compiler.lookup.PackageBinding) declaringElement2;
	...
	static boolean isEqual(org.summer.sdt.internal.compiler.lookup.MethodBinding methodBinding,
			org.summer.sdt.internal.compiler.lookup.MethodBinding methodBinding2) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(org.summer.sdt.internal.compiler.lookup.TypeBinding[] bindings, org.summer.sdt.internal.compiler.lookup.TypeBinding[] otherBindings) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(org.summer.sdt.internal.compiler.lookup.TypeBinding[] bindings, org.summer.sdt.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes) {
		if (bindings == null) {
			return otherBindings == null;
		}
		if (otherBindings == null) {
	...
	static boolean isEqual(org.summer.sdt.internal.compiler.lookup.TypeBinding typeBinding, org.summer.sdt.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes) {
		if (org.summer.sdt.internal.compiler.lookup.TypeBinding.equalsEquals(typeBinding, typeBinding2))
			return true;
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(org.summer.sdt.internal.compiler.lookup.TypeBinding typeBinding, org.summer.sdt.internal.compiler.lookup.TypeBinding typeBinding2) {
