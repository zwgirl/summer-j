 ...
 *     Stephan Herrmann - Contribution for Bug 342671 - ClassCastException: org.summer.sdt.internal.compiler.lookup.SourceTypeBinding cannot be cast to org.summer.sdt.internal.compiler.lookup.ArrayBinding
 *******************************************************************************/
...
class DefaultBindingResolver extends BindingResolver {
	...
	IBinding getBinding(org.summer.sdt.internal.compiler.lookup.Binding binding) {
		switch (binding.kind()) {
			case Binding.PACKAGE:
				return getPackageBinding((org.summer.sdt.internal.compiler.lookup.PackageBinding) binding);
			case Binding.TYPE:
			case Binding.BASE_TYPE:
			case Binding.GENERIC_TYPE:
			case Binding.PARAMETERIZED_TYPE:
			case Binding.RAW_TYPE:
				return getTypeBinding((org.summer.sdt.internal.compiler.lookup.TypeBinding) binding);
			case Binding.ARRAY_TYPE:
			case Binding.TYPE_PARAMETER:
				return new TypeBinding(this, (org.summer.sdt.internal.compiler.lookup.TypeBinding) binding);
			case Binding.METHOD:
				return getMethodBinding((org.summer.sdt.internal.compiler.lookup.MethodBinding) binding);
			case Binding.FIELD:
			case Binding.LOCAL:
				return getVariableBinding((org.summer.sdt.internal.compiler.lookup.VariableBinding) binding);
		}
		return null;
	}
	...
	Util.BindingsToNodesMap getBindingsToNodesMap() {
		return new Util.BindingsToNodesMap() {
			public org.summer.sdt.internal.compiler.ast.ASTNode get(Binding binding) {
				return (org.summer.sdt.internal.compiler.ast.ASTNode)
					DefaultBindingResolver.this.newAstToOldAst.get(DefaultBindingResolver.this.bindingsToAstNodes.get(binding));
			}
		};
	}

	synchronized org.summer.sdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
		return (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(currentNode);
	}

	/*
	 * Method declared on BindingResolver.
	 */
	synchronized IMethodBinding getMethodBinding(org.summer.sdt.internal.compiler.lookup.MethodBinding methodBinding) {
 		if (methodBinding != null && !methodBinding.isValidBinding()) {
			org.summer.sdt.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding =
				(org.summer.sdt.internal.compiler.lookup.ProblemMethodBinding) methodBinding;
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IPackageBinding getPackageBinding(org.summer.sdt.internal.compiler.lookup.PackageBinding packageBinding) {
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized ITypeBinding getTypeBinding(org.summer.sdt.internal.compiler.lookup.TypeBinding referenceBinding) {
			...
			switch(referenceBinding.problemId()) {
				...
				case ProblemReasons.NonStaticReferenceInStaticContext :
					if (referenceBinding instanceof ProblemReferenceBinding) {
						...
						org.summer.sdt.internal.compiler.lookup.TypeBinding binding2 = problemReferenceBinding.closestMatch();
	...
	synchronized IVariableBinding getVariableBinding(org.summer.sdt.internal.compiler.lookup.VariableBinding variableBinding, VariableDeclaration variableDeclaration) {
		if (this.isRecoveringBindings) {
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IVariableBinding getVariableBinding(org.summer.sdt.internal.compiler.lookup.VariableBinding variableBinding) {
		if (variableBinding != null) {
			if (variableBinding.isValidBinding()) {
				org.summer.sdt.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
	...
	synchronized IAnnotationBinding getAnnotationInstance(org.summer.sdt.internal.compiler.lookup.AnnotationBinding internalInstance) {
	...
	boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation) {
		...
		if (oldNode instanceof MessageSend) {
			...
			org.summer.sdt.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
	...
	/**
	 * @see org.summer.sdt.core.dom.BindingResolver#recordScope(ASTNode, BlockScope)
	 */
	...
	boolean resolveBoxing(Expression expression) {
		org.summer.sdt.internal.compiler.ast.ASTNode node = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node instanceof org.summer.sdt.internal.compiler.ast.Expression) {
			org.summer.sdt.internal.compiler.ast.Expression compilerExpression = (org.summer.sdt.internal.compiler.ast.Expression) node;
	...
	synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression) {
		org.summer.sdt.internal.compiler.ast.ASTNode node = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node != null && (node.bits & org.summer.sdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			org.summer.sdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (org.summer.sdt.internal.compiler.ast.TypeDeclaration) node;
	...
	IMethodBinding resolveConstructor(EnumConstantDeclaration enumConstantDeclaration) {
		...
		if (node instanceof org.summer.sdt.internal.compiler.ast.FieldDeclaration) {
		...
		try {
			switch(expression.getNodeType()) {
				case ASTNode.CLASS_INSTANCE_CREATION :
					org.summer.sdt.internal.compiler.ast.ASTNode astNode = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
					if (astNode instanceof org.summer.sdt.internal.compiler.ast.TypeDeclaration) {
						// anonymous type case
						org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.summer.sdt.internal.compiler.ast.TypeDeclaration) astNode;
				...
				case ASTNode.SINGLE_MEMBER_ANNOTATION :
					org.summer.sdt.internal.compiler.ast.Expression compilerExpression = (org.summer.sdt.internal.compiler.ast.Expression) this.newAstToOldAst.get(expression);
	...
	synchronized IBinding resolveImport(ImportDeclaration importDeclaration) {
		...
		try {
			org.summer.sdt.internal.compiler.ast.ASTNode node = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(importDeclaration);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
				final boolean isStatic = importReference.isStatic();
				if ((importReference.bits & org.summer.sdt.internal.compiler.ast.ASTNode.OnDemand) != 0) {
					...
					if (binding != null) {
						if (isStatic) {
							if (binding instanceof org.summer.sdt.internal.compiler.lookup.TypeBinding) {
								ITypeBinding typeBinding = this.getTypeBinding((org.summer.sdt.internal.compiler.lookup.TypeBinding) binding);
								return typeBinding == null ? null : typeBinding;
							}
						} else {
							if ((binding.kind() & Binding.PACKAGE) != 0) {
								IPackageBinding packageBinding = getPackageBinding((org.summer.sdt.internal.compiler.lookup.PackageBinding) binding);
								if (packageBinding == null) {
									return null;
								}
					...
					if (binding != null) {
						if (isStatic) {
							...
							} else if (binding instanceof org.summer.sdt.internal.compiler.lookup.MethodBinding) {
								// it is a type
								return getMethodBinding((org.summer.sdt.internal.compiler.lookup.MethodBinding)binding);
							}
						} else {
	...
	synchronized IMethodBinding resolveMethod(LambdaExpression lambda) {
		...
		if (oldNode instanceof org.summer.sdt.internal.compiler.ast.LambdaExpression) {
			org.summer.sdt.internal.compiler.ast.LambdaExpression lambdaExpression = (org.summer.sdt.internal.compiler.ast.LambdaExpression) oldNode;
...
/*
	...
	synchronized IMethodBinding resolveMethod(MethodReference methodReference) {
		...
		if (oldNode instanceof org.summer.sdt.internal.compiler.ast.ReferenceExpression) {
			org.summer.sdt.internal.compiler.ast.ReferenceExpression referenceExpression = (org.summer.sdt.internal.compiler.ast.ReferenceExpression) oldNode;
	...
	synchronized ITypeBinding resolveTypeBindingForName(Name name) {
		org.summer.sdt.internal.compiler.ast.ASTNode node = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(name);
		...
		if (node instanceof QualifiedNameReference) {
			...
			if (index < indexOfFirstFieldBinding) {
				...
				if (binding instanceof org.summer.sdt.internal.compiler.lookup.PackageBinding) {
					return null;
				} else if (binding instanceof org.summer.sdt.internal.compiler.lookup.TypeBinding) {
					// it is a type
					return this.getTypeBinding((org.summer.sdt.internal.compiler.lookup.TypeBinding)binding);
				}
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					org.summer.sdt.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
					if (type == null) { // array length scenario
						// use type from first binding (no capture needed for array type)
						switch (qualifiedNameReference.bits & org.summer.sdt.internal.compiler.ast.ASTNode.RestrictiveFlagMASK) {
							case Binding.FIELD:
			...
			if (index >= 0) {
				...
				if (importReferenceLength == index) {
					try {
						binding = this.scope.getImport(CharOperation.subarray(importReference.tokens, 0, index), (importReference.bits & org.summer.sdt.internal.compiler.ast.ASTNode.OnDemand) != 0, importReference.isStatic());
					} catch (AbortCompilation e) {
						// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=53357
					}
				} else {
			...
			org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.summer.sdt.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding != null) {
				return typeBinding;
			}
			...
			org.summer.sdt.internal.compiler.lookup.TypeBinding receiver = ((Receiver) node).type.resolvedType;
			...
			org.summer.sdt.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
			if (binding != null) {
		...
		} else if (node instanceof org.summer.sdt.internal.compiler.ast.TypeParameter) {
			org.summer.sdt.internal.compiler.ast.TypeParameter typeParameter = (org.summer.sdt.internal.compiler.ast.TypeParameter) node;
			return this.getTypeBinding(typeParameter.binding);
		} else if (node instanceof org.summer.sdt.internal.compiler.ast.MemberValuePair) {
			org.summer.sdt.internal.compiler.ast.MemberValuePair memberValuePair = (org.summer.sdt.internal.compiler.ast.MemberValuePair) node;
			IMethodBinding method = getMethodBinding(memberValuePair.binding);
			if (method == null) return null;
			return method.getReturnType();
		} else if (node instanceof org.summer.sdt.internal.compiler.ast.ReferenceExpression) {
			org.summer.sdt.internal.compiler.ast.ReferenceExpression referenceExpression = (org.summer.sdt.internal.compiler.ast.ReferenceExpression) node;
	...
	synchronized IBinding resolveName(Name name) {
		...
		if (node instanceof QualifiedNameReference) {
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					if (binding != null) {
						if (binding.isValidBinding()) {
							return this.getVariableBinding((org.summer.sdt.internal.compiler.lookup.VariableBinding) binding);
			...
			if (index >= 0) {
				...
				if (binding != null) {
					if (binding instanceof org.summer.sdt.internal.compiler.lookup.PackageBinding) {
						...
						// it is a type
						return this.getTypeBinding((org.summer.sdt.internal.compiler.lookup.TypeBinding)binding);
					} else if (binding instanceof org.summer.sdt.internal.compiler.lookup.FieldBinding) {
						// it is a type
						return this.getVariableBinding((org.summer.sdt.internal.compiler.lookup.FieldBinding)binding);
					} else if (binding instanceof org.summer.sdt.internal.compiler.lookup.MethodBinding) {
						// it is a type
						return getMethodBinding((org.summer.sdt.internal.compiler.lookup.MethodBinding)binding);
					} else {
			...
			org.summer.sdt.internal.compiler.ast.TypeDeclaration type = types[0];
			if (type != null) {
	...
	synchronized IPackageBinding resolvePackage(PackageDeclaration pkg) {
		if (this.scope == null) return null;
		try {
			org.summer.sdt.internal.compiler.ast.ASTNode node = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(pkg);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
	...
	synchronized IBinding resolveReference(MemberRef ref) {
		org.summer.sdt.internal.compiler.ast.Expression expression = (org.summer.sdt.internal.compiler.ast.Expression) this.newAstToOldAst.get(ref);
     ...
     * @since 3.2
	 */
	synchronized IMemberValuePairBinding resolveMemberValuePair(org.summer.sdt.core.dom.MemberValuePair memberValuePair) {
	...
	ITypeBinding resolveType(AnnotationTypeDeclaration type) {
		...
		if (node instanceof org.summer.sdt.internal.compiler.ast.TypeDeclaration) {
			org.summer.sdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.summer.sdt.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding == null) {
				return null;
	...
	synchronized ITypeBinding resolveType(AnonymousClassDeclaration type) {
		org.summer.sdt.internal.compiler.ast.ASTNode node = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		if (node != null && (node.bits & org.summer.sdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			org.summer.sdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (org.summer.sdt.internal.compiler.ast.TypeDeclaration) node;
	...
	synchronized ITypeBinding resolveType(Type type) {
		...
		org.summer.sdt.internal.compiler.ast.ASTNode node = (org.summer.sdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		org.summer.sdt.internal.compiler.lookup.TypeBinding binding = null;
		if (node != null) {
			...
			if (node instanceof ParameterizedQualifiedTypeReference) {
				...
				org.summer.sdt.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
...
//					return getTypeBinding(this.scope.createArrayType(arrayBinding.leafComponentType(), dimensions, getTypeAnnotations(dimensions, arrayBinding, isVarargs)));
			...
			if (((PrimitiveType) type).getPrimitiveTypeCode() == PrimitiveType.VOID) {
				return this.getTypeBinding(org.summer.sdt.internal.compiler.lookup.TypeBinding.VOID);
			}
		}
		return null;
	}
	private org.summer.sdt.internal.compiler.lookup.AnnotationBinding[] getTypeAnnotations(int dimensions, ArrayBinding arrayBinding, boolean isVarargs) {
		...
		if (cells > 0)
			System.arraycopy(oldies, i, newbies = new org.summer.sdt.internal.compiler.lookup.AnnotationBinding[cells], 0, cells);
		return newbies;
	}
	...
	synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter) {
		...
		if (node instanceof org.summer.sdt.internal.compiler.ast.TypeParameter) {
			org.summer.sdt.internal.compiler.ast.TypeParameter typeParameter2 = (org.summer.sdt.internal.compiler.ast.TypeParameter) node;
	...
	synchronized IVariableBinding resolveVariable(VariableDeclaration variable) {
		...
		if (node instanceof AbstractVariableDeclaration) {
			...
			if (abstractVariableDeclaration instanceof org.summer.sdt.internal.compiler.ast.FieldDeclaration) {
				org.summer.sdt.internal.compiler.ast.FieldDeclaration fieldDeclaration = (org.summer.sdt.internal.compiler.ast.FieldDeclaration) abstractVariableDeclaration;
	...
	synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode) {
		...
		if (oldNode instanceof org.summer.sdt.internal.compiler.ast.Annotation) {
			org.summer.sdt.internal.compiler.ast.Annotation internalAstNode =
				(org.summer.sdt.internal.compiler.ast.Annotation) oldNode;
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized void store(ASTNode node, org.summer.sdt.internal.compiler.ast.ASTNode oldASTNode) {
	...
	ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions) {
		...
		org.summer.sdt.internal.compiler.lookup.TypeBinding leafTypeBinding = 
	...
	private org.summer.sdt.internal.compiler.lookup.AnnotationBinding[] insertAnnotations(
							org.summer.sdt.internal.compiler.lookup.AnnotationBinding[] annots, int dimensions) {
		...
		org.summer.sdt.internal.compiler.lookup.AnnotationBinding[] newAnnots = 
				new org.summer.sdt.internal.compiler.lookup.AnnotationBinding[annots.length - index + dimensions];
