...
public void codeComplete(int offset, ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(offset, new org.summer.sdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
 ...
 * @deprecated
 */
public IJavaElement getWorkingCopy(IProgressMonitor monitor, org.summer.sdt.core.IBufferFactory factory) throws JavaModelException {
 ...
 */
public void codeComplete(int offset, final org.summer.sdt.core.ICodeCompletionRequestor requestor) throws JavaModelException {
