						...
						new IResourceProxyVisitor() {
							public boolean visit(IResourceProxy proxy) throws CoreException {
								if (proxy.getType() == IResource.FILE) {
									if (org.summer.sdt.internal.compiler.util.Util.isClassFileName(proxy.getName())) {
					...
					switch(proxy.getType()) {
						case IResource.FILE :
							if (org.summer.sdt.internal.core.util.Util.isJavaLikeFileName(proxy.getName()) ||
								org.summer.sdt.internal.compiler.util.Util.isClassFileName(proxy.getName())) return false;
