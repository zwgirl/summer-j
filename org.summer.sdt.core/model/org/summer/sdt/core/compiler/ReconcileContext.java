...
import org.summer.sdt.internal.core.ReconcileWorkingCopyOperation;
 ...
 * with JLS4 level.
 */
public org.summer.sdt.core.dom.CompilationUnit getAST3() throws JavaModelException {
	if (this.operation.astLevel != AST.JLS3 || !this.operation.resolveBindings) {
		...
		return (org.summer.sdt.core.dom.CompilationUnit) parser.createAST(this.operation.progressMonitor);
	}
 ...
 * @since 3.7.1
 */
public org.summer.sdt.core.dom.CompilationUnit getAST4() throws JavaModelException {
 ...
 * @since 3.10
 */
public org.summer.sdt.core.dom.CompilationUnit getAST8() throws JavaModelException {
