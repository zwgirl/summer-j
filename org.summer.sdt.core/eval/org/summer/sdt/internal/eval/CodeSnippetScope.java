...
import org.summer.sdt.internal.compiler.lookup.ProblemBinding;
...
public class CodeSnippetScope extends BlockScope {
	 ...
	 * @param kind int
	 * @param parent org.summer.sdt.internal.compiler.lookup.Scope
	 */
	...
	/**
	 * CodeSnippetScope constructor comment.
	 * @param parent org.summer.sdt.internal.compiler.lookup.BlockScope
	 */
	...
	*/
	...
	public FieldBinding findFieldForCodeSnippet(TypeBinding receiverType, char[] fieldName, InvocationSite invocationSite) {
		...
		if (interfacesToVisit != null) {
			...
			org.summer.sdt.internal.compiler.util.SimpleSet interfacesSeen = new org.summer.sdt.internal.compiler.util.SimpleSet(lastPosition * 2);
