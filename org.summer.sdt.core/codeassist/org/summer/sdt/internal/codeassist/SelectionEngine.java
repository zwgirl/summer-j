...
import org.summer.sdt.internal.core.SelectionRequestor;
...
public final class SelectionEngine extends Engine implements ISearchRequestor {
	 ...
	 *
	 *  @param nameEnvironment org.summer.sdt.internal.core.SearchableEnvironment
	 *      used to resolve type/package references and search for types/packages
	 *      based on partial names.
	 *
	 *  @param requestor org.summer.sdt.internal.codeassist.ISelectionRequestor
	...
	private void findAllTypes(char[] prefix) {
		try {
			...
			org.summer.sdt.core.ICompilationUnit[] workingCopies = this.owner == null ? null : JavaModelManager.getJavaModelManager().getWorkingCopies(this.owner, true/*add primary WCs*/);
	 ...
	 *
	 *  @param context org.summer.sdt.core.IType
	...
	public void selectType(char[] typeName, IType context) throws JavaModelException {
		try {
			...
			org.summer.sdt.core.ICompilationUnit cu = context.getCompilationUnit();
			if (cu != null) {
				...
				CompilationResult result = new CompilationResult((org.summer.sdt.internal.compiler.env.ICompilationUnit) cu, 1, 1, this.compilerOptions.maxProblemsPerUnit);
