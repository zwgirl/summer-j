...
import org.summer.sdt.internal.compiler.lookup.BinaryTypeBinding;
...
import org.summer.sdt.internal.compiler.lookup.SignatureWrapper;
...
public class InternalExtendedCompletionContext {
	...
	private void computeEnclosingJavaElements() {
		...
		if (this.typeRoot.getElementType() == IJavaElement.COMPILATION_UNIT) {
	 		ICompilationUnit original = (org.summer.sdt.core.ICompilationUnit)this.typeRoot;
			...
			org.summer.sdt.core.ICompilationUnit handle = new AssistCompilationUnit(original, this.owner, handleToBinding, handleToInfo);
