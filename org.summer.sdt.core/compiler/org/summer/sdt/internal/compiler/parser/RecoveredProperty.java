...
public class RecoveredProperty extends RecoveredElement {

	public PropertyDeclaration fieldDeclaration;
	...
	public RecoveredProperty(PropertyDeclaration propertyDeclaration, RecoveredElement parent, int bracketBalance){
		this(propertyDeclaration, parent, bracketBalance, null);
	}
	public RecoveredProperty(PropertyDeclaration fieldDeclaration, RecoveredElement parent, int bracketBalance, Parser parser){
	 ...
	 */
	public RecoveredElement add(PropertyDeclaration addedPropertyDeclaration, int bracketBalanceValue) {
	
		/* default behavior is to delegate recording to parent if any */
		resetPendingModifiers();
		if (this.parent == null) return this; // ignore
		
		if (this.fieldDeclaration.declarationSourceStart == addedPropertyDeclaration.declarationSourceStart) {
			...
			this.updateSourceEndIfNecessary(previousAvailableLineEnd(addedPropertyDeclaration.declarationSourceStart - 1));
		}
		return this.parent.add(addedPropertyDeclaration, bracketBalanceValue);
	}
	/*
	...
	public PropertyDeclaration updatedPropertyDeclaration(int depth, Set knownTypes){
		/* update annotations */
		if (this.modifiers != 0) {
...
//				}
	...
	public void updateParseTree(){
		updatedPropertyDeclaration(0, new HashSet());
	}
	/*
