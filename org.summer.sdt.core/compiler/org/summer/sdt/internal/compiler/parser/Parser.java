	...
	protected void consumeRule(int act) {
	  switch ( act ) {
	    ...
	    case 127 : if (DEBUG) { System.out.println("CloseTag ::= CLOSE_ELEMENT DOT HtmlName"); }  //$NON-NLS-1$
			    consumeHtmlJoinElementCloseTag();  
				break;
	    ...
	    case 138 : if (DEBUG) { System.out.println("Attribute ::= AttributeStart EQUAL PropertyExpression"); }  //$NON-NLS-1$
			    consumeHtmlAttribute();  
				break;
	 
	    case 139 : if (DEBUG) { System.out.println("AttributeListopt ::="); }  //$NON-NLS-1$
			    consumeHtmlAttributeListopt();  
				break;
	 
	    case 142 : if (DEBUG) { System.out.println("AttributeList ::= AttributeList Attribute"); }  //$NON-NLS-1$
			    consumeHtmlAttributeList();  
				break;
	 
	    case 152 : if (DEBUG) { System.out.println("FunctionExpression ::= FunctionExpressionHeader..."); }  //$NON-NLS-1$
			    consumeHtmlFunctionExpression();  
				break;
	 
	    case 153 : if (DEBUG) { System.out.println("FunctionExpressionHeader ::= function"); }  //$NON-NLS-1$
			    consumeHtmlFunctionExpressionHeader();  
				break;
	 
	    case 154 : if (DEBUG) { System.out.println("MarkupExtenson ::= LBRACE SimpleName AttributeListopt..."); }  //$NON-NLS-1$
	    ...
	    case 209 : if (DEBUG) { System.out.println("FunctionTypeDeclaration ::= FunctionTypeHeaderName..."); }  //$NON-NLS-1$
			    consumeFunctionTypeDeclaration();  
				break;
	 
	    case 210 : if (DEBUG) { System.out.println("FunctionTypeHeaderName ::= Modifiersopt function Type..."); }  //$NON-NLS-1$
	    ...
	    case 212 : if (DEBUG) { System.out.println("FunctionTypeHeaderRightParen ::= RPAREN"); }  //$NON-NLS-1$
			    consumeFunctionTypeHeaderRightParen();  
				break;
	 
	    case 215 : if (DEBUG) { System.out.println("FunctionHeaderThrowsClause ::= throws ClassTypeList"); }  //$NON-NLS-1$
			    consumeFunctionHeaderThrowsClause();  
				break;
	 
	    case 216 : if (DEBUG) { System.out.println("ClassDeclaration ::= ClassHeader ClassBody"); }  //$NON-NLS-1$
			    consumeClassDeclaration();  
				break;
	 
	    case 217 : if (DEBUG) { System.out.println("ClassHeader ::= ClassHeaderName ClassHeaderExtendsopt..."); }  //$NON-NLS-1$
			    consumeClassHeader();  
				break;
	 
	    case 218 : if (DEBUG) { System.out.println("ClassHeaderName ::= ClassHeaderName1 TypeParameters"); }  //$NON-NLS-1$
			    consumeTypeHeaderNameWithTypeParameters();  
				break;
	 
	    case 220 : if (DEBUG) { System.out.println("ClassHeaderName1 ::= Modifiersopt class Identifier"); }  //$NON-NLS-1$
			    consumeClassHeaderName1();  
				break;
	 
	    case 221 : if (DEBUG) { System.out.println("ClassHeaderExtends ::= extends ClassType"); }  //$NON-NLS-1$
			    consumeClassHeaderExtends();  
				break;
	 
	    case 222 : if (DEBUG) { System.out.println("ClassHeaderImplements ::= implements InterfaceTypeList"); }  //$NON-NLS-1$
			    consumeClassHeaderImplements();  
				break;
	 
	    case 224 : if (DEBUG) { System.out.println("InterfaceTypeList ::= InterfaceTypeList COMMA..."); }  //$NON-NLS-1$
			    consumeInterfaceTypeList();  
				break;
	 
	    case 225 : if (DEBUG) { System.out.println("InterfaceType ::= ClassOrInterfaceType"); }  //$NON-NLS-1$
			    consumeInterfaceType();  
				break;
	 
	    case 228 : if (DEBUG) { System.out.println("ClassBodyDeclarations ::= ClassBodyDeclarations..."); }  //$NON-NLS-1$
			    consumeClassBodyDeclarations();  
				break;
	 
	    case 232 : if (DEBUG) { System.out.println("ClassBodyDeclaration ::= Diet NestedMethod..."); }  //$NON-NLS-1$
			    consumeClassBodyDeclaration();  
				break;
	 
	    case 233 : if (DEBUG) { System.out.println("Diet ::="); }  //$NON-NLS-1$
			    consumeDiet();  
				break;

	    case 234 : if (DEBUG) { System.out.println("Initializer ::= Diet NestedMethod CreateInitializer Block"); }  //$NON-NLS-1$
			    consumeClassBodyDeclaration();  
				break;
	 
	    case 235 : if (DEBUG) { System.out.println("CreateInitializer ::="); }  //$NON-NLS-1$
			    consumeCreateInitializer();  
				break;

	    case 237 : if (DEBUG) { System.out.println("PropertyDeclaration ::= Modifiersopt Type Identifier..."); }  //$NON-NLS-1$
			    consumePropertyDeclaration();  
				break;

	    case 238 : if (DEBUG) { System.out.println("PropertyHeader ::="); }  //$NON-NLS-1$
			    consumePropertyHeader();  
				break;

	    case 239 : if (DEBUG) { System.out.println("AccessorDeclaration ::="); }  //$NON-NLS-1$
			    consumeEmptyAccessor();  
				break;

	    case 243 : if (DEBUG) { System.out.println("SetAccessorDeclarationopt ::= SetAccessorDeclaration"); }  //$NON-NLS-1$
			    consumeAccessoropt();  
				break;

	    case 244 : if (DEBUG) { System.out.println("SetAccessorDeclaration ::= SetterMethodHeader MethodBody"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(true, false);   
				break;

	    case 245 : if (DEBUG) { System.out.println("SetAccessorDeclaration ::= SetterMethodHeader SEMICOLON"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(false, false);   
				break;

	    case 246 : if (DEBUG) { System.out.println("SetterMethodHeader ::= PLUS"); }  //$NON-NLS-1$
			    consumeAccessorMethodName(MethodDeclaration.SETTER);  
				break;

	    case 248 : if (DEBUG) { System.out.println("GetAccessorDeclarationopt ::= GetAccessorDeclaration"); }  //$NON-NLS-1$
			    consumeAccessoropt();  
				break;

	    case 249 : if (DEBUG) { System.out.println("GetAccessorDeclaration ::= GetterMethodHeader MethodBody"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(true, false);   
				break;

	    case 250 : if (DEBUG) { System.out.println("GetAccessorDeclaration ::= GetterMethodHeader SEMICOLON"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(false, false);   
				break;

	    case 251 : if (DEBUG) { System.out.println("GetterMethodHeader ::= AND"); }  //$NON-NLS-1$
			    consumeAccessorMethodName(MethodDeclaration.GETTER);  
				break;

	    case 253 : if (DEBUG) { System.out.println("IndexerDeclaration ::= IndexerHeader FormalParameter..."); }  //$NON-NLS-1$
	    ...
	    case 255 : if (DEBUG) { System.out.println("IndexerHeader ::= Modifiersopt Type this LBRACKET"); }  //$NON-NLS-1$
	 ...
	 consumeMethodDeclaration(false, false);  
	    ...
	    case 282 : if (DEBUG) { System.out.println("AbstractMethodDeclaration ::= MethodHeader CODE_DATA..."); }  //$NON-NLS-1$
			    // set to false to consume a method without body
	 consumeMethodDeclarationWithCode(false, false);  
	    ...
	    case 297 : if (DEBUG) { System.out.println("FormalParameter ::= Modifiersopt Type..."); }  //$NON-NLS-1$
	    ...
	    case 299 : if (DEBUG) { System.out.println("CatchFormalParameter ::= Modifiersopt CatchType..."); }  //$NON-NLS-1$
			    consumeCatchFormalParameter();  
				break;
	 
	    case 300 : if (DEBUG) { System.out.println("CatchType ::= UnionType"); }  //$NON-NLS-1$
			    consumeCatchType();  
				break;
	 
	    case 301 : if (DEBUG) { System.out.println("UnionType ::= Type"); }  //$NON-NLS-1$
			    consumeUnionTypeAsClassType();  
				break;
	 
	    case 302 : if (DEBUG) { System.out.println("UnionType ::= UnionType OR Type"); }  //$NON-NLS-1$
			    consumeUnionType();  
				break;
	 
	    case 304 : if (DEBUG) { System.out.println("ClassTypeList ::= ClassTypeList COMMA ClassTypeElt"); }  //$NON-NLS-1$
			    consumeClassTypeList();  
				break;
	 
	    case 305 : if (DEBUG) { System.out.println("ClassTypeElt ::= ClassType"); }  //$NON-NLS-1$
			    consumeClassTypeElt();  
				break;
	 
	    case 306 : if (DEBUG) { System.out.println("MethodBody ::= NestedMethod LBRACE BlockStatementsopt..."); }  //$NON-NLS-1$
			    consumeMethodBody();  
				break;
	 
	    case 307 : if (DEBUG) { System.out.println("NestedMethod ::="); }  //$NON-NLS-1$
			    consumeNestedMethod();  
				break;
	 
	    case 308 : if (DEBUG) { System.out.println("StaticInitializer ::= StaticOnly Block"); }  //$NON-NLS-1$
			    consumeStaticInitializer();  
				break;

	    case 309 : if (DEBUG) { System.out.println("StaticOnly ::= static"); }  //$NON-NLS-1$
			    consumeStaticOnly();  
				break;
	 
	    case 310 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader MethodBody"); }  //$NON-NLS-1$
			    consumeConstructorDeclaration() ;  
				break;
	 
	    case 311 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader SEMICOLON"); }  //$NON-NLS-1$
			    consumeInvalidConstructorDeclaration() ;  
				break;
	 
	    case 312 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader CODE_DATA..."); }  //$NON-NLS-1$
			    consumeInvalidConstructorDeclarationWithJSNI();  
				break;
	 
	    case 313 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= this LPAREN..."); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocation(0, THIS_CALL);  
				break;
	 
	    case 314 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= this OnlyTypeArguments"); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocationWithTypeArguments(0,THIS_CALL);  
				break;
	 
	    case 315 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= super LPAREN..."); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocation(0,SUPER_CALL);  
				break;
	 
	    case 316 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= super OnlyTypeArguments"); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocationWithTypeArguments(0,SUPER_CALL);  
				break;
	 
	    case 317 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Primary DOT super..."); }  //$NON-NLS-1$
	    ...
	    case 319 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT super LPAREN"); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocation(2, SUPER_CALL);  
				break;
	 
	    case 320 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT super..."); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocationWithTypeArguments(2, SUPER_CALL);  
				break;
	 
	    case 321 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Primary DOT this LPAREN"); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocation(1, THIS_CALL);  
				break;
	 
	    case 322 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Primary DOT this..."); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocationWithTypeArguments(1, THIS_CALL);  
				break;
	 
	    case 323 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT this LPAREN..."); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocation(2, THIS_CALL);  
				break;
	 
	    case 324 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT this..."); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocationWithTypeArguments(2, THIS_CALL);  
				break;
	 
	    case 325 : if (DEBUG) { System.out.println("InterfaceDeclaration ::= InterfaceHeader InterfaceBody"); }  //$NON-NLS-1$
			    consumeInterfaceDeclaration();  
				break;
	 
	    case 326 : if (DEBUG) { System.out.println("InterfaceHeader ::= InterfaceHeaderName..."); }  //$NON-NLS-1$
			    consumeInterfaceHeader();  
				break;
	 
	    case 327 : if (DEBUG) { System.out.println("InterfaceHeaderName ::= InterfaceHeaderName1..."); }  //$NON-NLS-1$
			    consumeTypeHeaderNameWithTypeParameters();  
				break;
	 
	    case 329 : if (DEBUG) { System.out.println("InterfaceHeaderName1 ::= Modifiersopt interface..."); }  //$NON-NLS-1$
			    consumeInterfaceHeaderName1();  
				break;
	 
	    case 330 : if (DEBUG) { System.out.println("InterfaceHeaderExtends ::= extends InterfaceTypeList"); }  //$NON-NLS-1$
			    consumeInterfaceHeaderExtends();  
				break;
	 
	    case 333 : if (DEBUG) { System.out.println("InterfaceMemberDeclarations ::=..."); }  //$NON-NLS-1$
			    consumeInterfaceMemberDeclarations();  
				break;
	 
	    case 334 : if (DEBUG) { System.out.println("InterfaceMemberDeclaration ::= SEMICOLON"); }  //$NON-NLS-1$
			    consumeEmptyTypeDeclaration();  
				break;
	 
	    case 338 : if (DEBUG) { System.out.println("InterfaceMemberDeclaration ::= DefaultMethodHeader..."); }  //$NON-NLS-1$
			    consumeInterfaceMethodDeclaration(false);  
				break;
	 
	    case 339 : if (DEBUG) { System.out.println("InterfaceMemberDeclaration ::= MethodHeader MethodBody"); }  //$NON-NLS-1$
			    consumeInterfaceMethodDeclaration(false);  
				break;
	 
	    case 340 : if (DEBUG) { System.out.println("InterfaceMemberDeclaration ::= DefaultMethodHeader..."); }  //$NON-NLS-1$
			    consumeInterfaceMethodDeclaration(true);  
				break;
	 
	    case 341 : if (DEBUG) { System.out.println("InvalidConstructorDeclaration ::= ConstructorHeader..."); }  //$NON-NLS-1$
	    ...
	    case 401 : if (DEBUG) { System.out.println("EmptyStatement ::= SEMICOLON"); }  //$NON-NLS-1$
			    consumeEmptyStatement();  
				break;
	 
	    case 402 : if (DEBUG) { System.out.println("LabeledStatement ::= Label COLON Statement"); }  //$NON-NLS-1$
			    consumeStatementLabel() ;  
				break;
	 
	    case 403 : if (DEBUG) { System.out.println("LabeledStatementNoShortIf ::= Label COLON..."); }  //$NON-NLS-1$
			    consumeStatementLabel() ;  
				break;
	 
	    case 404 : if (DEBUG) { System.out.println("Label ::= Identifier"); }  //$NON-NLS-1$
			    consumeLabel() ;  
				break;
	 
	     case 405 : if (DEBUG) { System.out.println("ExpressionStatement ::= StatementExpression SEMICOLON"); }  //$NON-NLS-1$
			    consumeExpressionStatement();  
				break;
	 
	    case 414 : if (DEBUG) { System.out.println("IfThenStatement ::= if LPAREN Expression RPAREN Statement"); }  //$NON-NLS-1$
			    consumeStatementIfNoElse();  
				break;
	 
	    case 415 : if (DEBUG) { System.out.println("IfThenElseStatement ::= if LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
			    consumeStatementIfWithElse();  
				break;
	 
	    case 416 : if (DEBUG) { System.out.println("IfThenElseStatementNoShortIf ::= if LPAREN Expression..."); }  //$NON-NLS-1$
			    consumeStatementIfWithElse();  
				break;
	 
	    case 417 : if (DEBUG) { System.out.println("SwitchStatement ::= switch LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
			    consumeStatementSwitch() ;  
				break;
	 
	    case 418 : if (DEBUG) { System.out.println("SwitchBlock ::= LBRACE RBRACE"); }  //$NON-NLS-1$
			    consumeEmptySwitchBlock() ;  
				break;
	 
	    case 421 : if (DEBUG) { System.out.println("SwitchBlock ::= LBRACE SwitchBlockStatements SwitchLabels"); }  //$NON-NLS-1$
			    consumeSwitchBlock() ;  
				break;
	 
	    case 423 : if (DEBUG) { System.out.println("SwitchBlockStatements ::= SwitchBlockStatements..."); }  //$NON-NLS-1$
			    consumeSwitchBlockStatements() ;  
				break;
	 
	    case 424 : if (DEBUG) { System.out.println("SwitchBlockStatement ::= SwitchLabels BlockStatements"); }  //$NON-NLS-1$
			    consumeSwitchBlockStatement() ;  
				break;
	 
	    case 426 : if (DEBUG) { System.out.println("SwitchLabels ::= SwitchLabels SwitchLabel"); }  //$NON-NLS-1$
			    consumeSwitchLabels() ;  
				break;
	 
	     case 427 : if (DEBUG) { System.out.println("SwitchLabel ::= case ConstantExpression COLON"); }  //$NON-NLS-1$
			    consumeCaseLabel();  
				break;
	 
	     case 428 : if (DEBUG) { System.out.println("SwitchLabel ::= default COLON"); }  //$NON-NLS-1$
			    consumeDefaultLabel();  
				break;
	 
	    case 429 : if (DEBUG) { System.out.println("WhileStatement ::= while LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
			    consumeStatementWhile() ;  
				break;
	 
	    case 430 : if (DEBUG) { System.out.println("WhileStatementNoShortIf ::= while LPAREN Expression..."); }  //$NON-NLS-1$
			    consumeStatementWhile() ;  
				break;
	 
	    case 431 : if (DEBUG) { System.out.println("DoStatement ::= do Statement while LPAREN Expression..."); }  //$NON-NLS-1$
			    consumeStatementDo() ;  
				break;
	 
	    case 432 : if (DEBUG) { System.out.println("ForStatement ::= for LPAREN ForInitopt SEMICOLON..."); }  //$NON-NLS-1$
			    consumeStatementFor() ;  
				break;
	 
	    case 433 : if (DEBUG) { System.out.println("ForStatementNoShortIf ::= for LPAREN ForInitopt SEMICOLON"); }  //$NON-NLS-1$
			    consumeStatementFor() ;  
				break;
	 
	    case 434 : if (DEBUG) { System.out.println("ForInit ::= StatementExpressionList"); }  //$NON-NLS-1$
			    consumeForInit() ;  
				break;
	 
	    case 438 : if (DEBUG) { System.out.println("StatementExpressionList ::= StatementExpressionList COMMA"); }  //$NON-NLS-1$
			    consumeStatementExpressionList() ;  
				break;
	 
	    case 439 : if (DEBUG) { System.out.println("BreakStatement ::= break SEMICOLON"); }  //$NON-NLS-1$
			    consumeStatementBreak() ;  
				break;
	 
	    case 440 : if (DEBUG) { System.out.println("BreakStatement ::= break Identifier SEMICOLON"); }  //$NON-NLS-1$
			    consumeStatementBreakWithLabel() ;  
				break;
	 
	    case 441 : if (DEBUG) { System.out.println("ContinueStatement ::= continue SEMICOLON"); }  //$NON-NLS-1$
			    consumeStatementContinue() ;  
				break;
	 
	    case 442 : if (DEBUG) { System.out.println("ContinueStatement ::= continue Identifier SEMICOLON"); }  //$NON-NLS-1$
			    consumeStatementContinueWithLabel() ;  
				break;
	 
	    case 443 : if (DEBUG) { System.out.println("ReturnStatement ::= return Expressionopt SEMICOLON"); }  //$NON-NLS-1$
			    consumeStatementReturn() ;  
				break;
	 
	    case 444 : if (DEBUG) { System.out.println("ThrowStatement ::= throw Expression SEMICOLON"); }  //$NON-NLS-1$
	    ...
	    case 465 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name DOT super"); }  //$NON-NLS-1$
	    ...
	    case 499 : if (DEBUG) { System.out.println("AllocationHeader ::= new ClassType LPAREN ArgumentListopt"); }  //$NON-NLS-1$
			    consumeAllocationHeader();  
				break;
	 
	    case 500 : if (DEBUG) { System.out.println("ClassInstanceCreationExpression ::= new OnlyTypeArguments"); }  //$NON-NLS-1$
	    ...
	    case 535 : if (DEBUG) { System.out.println("MethodInvocation ::= MethodInvocation LPAREN..."); }  //$NON-NLS-1$
			    consumeMethodInvocationInvocation();  
				break;
	 
	    case 536 : if (DEBUG) { System.out.println("MethodInvocation ::= ArrayAccess LPAREN ArgumentListopt"); }  //$NON-NLS-1$
			    consumeMethodInvocationArraySccess();  
				break;
	 
	    case 537 : if (DEBUG) { System.out.println("MethodInvocation ::= LambdaExpression LPAREN..."); }  //$NON-NLS-1$
	    ...
	    case 543 : if (DEBUG) { System.out.println("ArrayAccess ::= super LBRACKET Expression RBRACKET"); }  //$NON-NLS-1$
			    consumeArrayAccess(true);  
				break;
	    ...
	    case 551 : if (DEBUG) { System.out.println("PostDecrementExpression ::= PostfixExpression MINUS_MINUS"); }  //$NON-NLS-1$
	    ...
	    case 599 : if (DEBUG) { System.out.println("EqualityExpression ::= EqualityExpression..."); }  //$NON-NLS-1$
			    consumeEqualityExpression(OperatorIds.EQUAL_EQUAL_EQUAL);  
				break;
	 
	    case 600 : if (DEBUG) { System.out.println("EqualityExpression ::= EqualityExpression NOT_EQUAL_EQUAL"); }  //$NON-NLS-1$
	    ...
	    case 611 : if (DEBUG) { System.out.println("ConditionalOrExpression ::= ConditionalOrExpression OR_OR"); }  //$NON-NLS-1$
	    ...
	    case 640 : if (DEBUG) { System.out.println("ClassBodyDeclarationsopt ::= NestedType HtmlSection"); }  //$NON-NLS-1$
	    ...
	    case 642 : if (DEBUG) { System.out.println("ClassBodyDeclarationsopt ::= NestedType HtmlSection..."); }  //$NON-NLS-1$
	    ...
	    case 659 : if (DEBUG) { System.out.println("NestedType ::="); }  //$NON-NLS-1$
	     ...
	     case 673 : if (DEBUG) { System.out.println("EnumBody ::= LBRACE COMMA EnumBodyDeclarationsopt RBRACE"); }  //$NON-NLS-1$
			    consumeEnumBodyNoConstants();  
				break;
	    ...
	    case 679 : if (DEBUG) { System.out.println("EnumConstantHeader ::= EnumConstantHeaderName ForceNoDiet"); }  //$NON-NLS-1$
			    consumeEnumConstantHeader();  
				break;
	 
	    case 680 : if (DEBUG) { System.out.println("EnumConstant ::= EnumConstantHeader ForceNoDiet ClassBody"); }  //$NON-NLS-1$
	    ...
	    case 725 : if (DEBUG) { System.out.println("Wildcard1 ::= TypeAnnotationsopt QUESTION WildcardBounds1"); }  //$NON-NLS-1$
	    ...
	    case 729 : if (DEBUG) { System.out.println("Wildcard2 ::= TypeAnnotationsopt QUESTION WildcardBounds2"); }  //$NON-NLS-1$
	    ...
	    case 733 : if (DEBUG) { System.out.println("Wildcard3 ::= TypeAnnotationsopt QUESTION WildcardBounds3"); }  //$NON-NLS-1$
	    ...
	    case 774 : if (DEBUG) { System.out.println("AdditiveExpression_NotName ::= AdditiveExpression_NotName"); }  //$NON-NLS-1$
			    consumeBinaryExpression(OperatorIds.PLUS);  
				break;
	    ...
	    case 776 : if (DEBUG) { System.out.println("AdditiveExpression_NotName ::= AdditiveExpression_NotName"); }  //$NON-NLS-1$
			    consumeBinaryExpression(OperatorIds.MINUS);  
				break;
	    ...
	    case 798 : if (DEBUG) { System.out.println("EqualityExpression_NotName ::= EqualityExpression_NotName"); }  //$NON-NLS-1$
			    consumeEqualityExpression(OperatorIds.EQUAL_EQUAL);  
				break;
	    ...
	    case 800 : if (DEBUG) { System.out.println("EqualityExpression_NotName ::= EqualityExpression_NotName"); }  //$NON-NLS-1$
			    consumeEqualityExpression(OperatorIds.NOT_EQUAL);  
				break;
	    ...
	    case 870 : if (DEBUG) { System.out.println("RecoveryMethodHeaderName ::= Modifiersopt Type Identifier"); }  //$NON-NLS-1$
...
//		new SingleTypeReference1(new char[][]{SWITCH}, new long[]{(((long) thisStart << 32)) + (thisStart + 6)});
	...
	protected void consumeHtmlJoinElementCloseTag(){
