...
//		this.identifierLengthPtr--;
	...
	protected void consumeRule(int act) {
	  switch ( act ) {
	    ...
	    case 111 : if (DEBUG) { System.out.println("EmptyElement ::= ElementTag EnterCloseTag EnterPCDATA..."); }  //$NON-NLS-1$
			    consumeEmptyElement();  
				break;
	 
	    case 112 : if (DEBUG) { System.out.println("SimpleElement ::= ElementTag AttributeList EnterCloseTag"); }  //$NON-NLS-1$
			    consumeSimpleElement();  
				break;
	 
	    case 113 : if (DEBUG) { System.out.println("ComplexElement ::= ElementStart ElementListopt..."); }  //$NON-NLS-1$
			    consumeComplexElement();  
				break;
	 
	    case 114 : if (DEBUG) { System.out.println("ElementStart ::= ElementTag AttributeListopt EnterPCDATA"); }  //$NON-NLS-1$
			    consumeElementStart();  
				break;
	 
	    case 115 : if (DEBUG) { System.out.println("ElementClose ::= CLOSE_ELEMENT EnterCloseTag SimpleName"); }  //$NON-NLS-1$
			    consumeElementClose();  
				break;
	 
	    case 116 : if (DEBUG) { System.out.println("EnterCloseTag ::="); }  //$NON-NLS-1$
			    consumeEnterCloseTag();  
				break;
	 
	    case 117 : if (DEBUG) { System.out.println("EnterPCDATA ::="); }  //$NON-NLS-1$
			    consumeEnterPCADATA();  
				break;
	 
	    case 118 : if (DEBUG) { System.out.println("AttributeListopt ::="); }  //$NON-NLS-1$
			    consumeAttributeListopt();  
				break;
	 
	    case 120 : if (DEBUG) { System.out.println("ElementTag ::= LESS SimpleName"); }  //$NON-NLS-1$
			    consumeElementTag();  
				break;
	 
	    case 121 : if (DEBUG) { System.out.println("Attribute ::= SimpleName COLON SimpleName EQUAL..."); }  //$NON-NLS-1$
			    consumeAttributeWithTypeReference();  
				break;
	 
	    case 122 : if (DEBUG) { System.out.println("Attribute ::= SimpleName EQUAL PropertyExpression"); }  //$NON-NLS-1$
			    consumeAttribute();  
				break;
	 
	    case 123 : if (DEBUG) { System.out.println("Attribute ::= SimpleName DOT SimpleName EQUAL..."); }  //$NON-NLS-1$
			    consumeAttributeWithPropertyReference();  
				break;
	 
	    case 125 : if (DEBUG) { System.out.println("AttributeList ::= AttributeList Attribute"); }  //$NON-NLS-1$
			    consumeAttributeList();  
				break;
	 
	    case 135 : if (DEBUG) { System.out.println("FunctionExpression ::= FunctionExpressionHeader..."); }  //$NON-NLS-1$
			    consumeFunctionExpression();  
				break;
	 
	    case 136 : if (DEBUG) { System.out.println("FunctionExpressionHeader ::= function"); }  //$NON-NLS-1$
			    consumeFunctionExpressionHeader();  
				break;
	 
	    case 137 : if (DEBUG) { System.out.println("consumeMarkupExtensionTag ::= LBRACE SimpleName"); }  //$NON-NLS-1$
			    consumeMarkupExtensionTag();  
				break;
	 
	    case 138 : if (DEBUG) { System.out.println("MarkupExtenson ::= consumeMarkupExtensionTag RBRACE"); }  //$NON-NLS-1$
			    consumeMarkupExtenson(false);  
				break;
	 
	    case 139 : if (DEBUG) { System.out.println("MarkupExtenson ::= consumeMarkupExtensionTag..."); }  //$NON-NLS-1$
