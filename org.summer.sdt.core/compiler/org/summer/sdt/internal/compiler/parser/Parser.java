...
//		this.identifierLengthPtr--;
	...
	protected void consumeRule(int act) {
	  switch ( act ) {
	    ...
	    case 154 : if (DEBUG) { System.out.println("CatchHeader ::= catch LPAREN CatchFormalParameter RPAREN"); }  //$NON-NLS-1$
			    consumeCatchHeader();  
				break;
	 
	    case 156 : if (DEBUG) { System.out.println("ImportDeclarations ::= ImportDeclarations..."); }  //$NON-NLS-1$
			    consumeImportDeclarations();  
				break;
	 
	    case 158 : if (DEBUG) { System.out.println("TypeDeclarations ::= TypeDeclarations TypeDeclaration"); }  //$NON-NLS-1$
			    consumeTypeDeclarations();  
				break;
	 
	    case 159 : if (DEBUG) { System.out.println("PackageDeclaration ::= PackageDeclarationName SEMICOLON"); }  //$NON-NLS-1$
			    consumePackageDeclaration();  
				break;
	 
	    case 160 : if (DEBUG) { System.out.println("PackageDeclarationName ::= Modifiers package..."); }  //$NON-NLS-1$
			    consumePackageDeclarationNameWithModifiers();  
				break;
	 
	    case 161 : if (DEBUG) { System.out.println("PackageDeclarationName ::= PackageComment package Name..."); }  //$NON-NLS-1$
			    consumePackageDeclarationName();  
				break;
	 
	    case 162 : if (DEBUG) { System.out.println("PackageComment ::="); }  //$NON-NLS-1$
			    consumePackageComment();  
				break;
	 
	    case 167 : if (DEBUG) { System.out.println("SingleTypeImportDeclaration ::=..."); }  //$NON-NLS-1$
			    consumeImportDeclaration();  
				break;
	 
	    case 168 : if (DEBUG) { System.out.println("SingleTypeImportDeclarationName ::= import Name..."); }  //$NON-NLS-1$
			    consumeSingleTypeImportDeclarationName();  
				break;
	 
	    case 169 : if (DEBUG) { System.out.println("TypeImportOnDemandDeclaration ::=..."); }  //$NON-NLS-1$
			    consumeImportDeclaration();  
				break;
	 
	    case 170 : if (DEBUG) { System.out.println("TypeImportOnDemandDeclarationName ::= import Name DOT..."); }  //$NON-NLS-1$
			    consumeTypeImportOnDemandDeclarationName();  
				break;
	 
	     case 174 : if (DEBUG) { System.out.println("TypeDeclaration ::= SEMICOLON"); }  //$NON-NLS-1$
			    consumeEmptyTypeDeclaration();  
				break;
	 
	    case 178 : if (DEBUG) { System.out.println("Modifiers ::= Modifiers Modifier"); }  //$NON-NLS-1$
			    consumeModifiers2();  
				break;
	 
	    case 190 : if (DEBUG) { System.out.println("Modifier ::= Annotation"); }  //$NON-NLS-1$
			    consumeAnnotationAsModifier();  
				break;
	 
	    case 191 : if (DEBUG) { System.out.println("FunctionTypeDeclaration ::= FunctionTypeHeaderName..."); }  //$NON-NLS-1$
	    ...
	    case 193 : if (DEBUG) { System.out.println("FunctionTypeHeaderName ::= Modifiersopt function Type..."); }  //$NON-NLS-1$
			    consumeFunctionTypeHeaderName();  
				break;
	 
	    case 194 : if (DEBUG) { System.out.println("FunctionTypeHeaderRightParen ::= RPAREN"); }  //$NON-NLS-1$
			    consumeFunctionTypeHeaderRightParen();  
				break;
	 
	    case 197 : if (DEBUG) { System.out.println("FunctionHeaderThrowsClause ::= throws ClassTypeList"); }  //$NON-NLS-1$
	    ...
	    case 202 : if (DEBUG) { System.out.println("ClassHeaderName1 ::= Modifiersopt class Identifier"); }  //$NON-NLS-1$
			    consumeClassHeaderName1();  
				break;
	 
	    case 203 : if (DEBUG) { System.out.println("ClassHeaderExtends ::= extends ClassType"); }  //$NON-NLS-1$
			    consumeClassHeaderExtends();  
				break;
	 
	    case 204 : if (DEBUG) { System.out.println("ClassHeaderImplements ::= implements InterfaceTypeList"); }  //$NON-NLS-1$
			    consumeClassHeaderImplements();  
				break;
	 
	    case 206 : if (DEBUG) { System.out.println("InterfaceTypeList ::= InterfaceTypeList COMMA..."); }  //$NON-NLS-1$
			    consumeInterfaceTypeList();  
				break;
	 
	    case 207 : if (DEBUG) { System.out.println("InterfaceType ::= ClassOrInterfaceType"); }  //$NON-NLS-1$
			    consumeInterfaceType();  
				break;
	 
	    case 210 : if (DEBUG) { System.out.println("ClassBodyDeclarations ::= ClassBodyDeclarations..."); }  //$NON-NLS-1$
			    consumeClassBodyDeclarations();  
				break;
	 
	    case 214 : if (DEBUG) { System.out.println("ClassBodyDeclaration ::= Diet NestedMethod..."); }  //$NON-NLS-1$
			    consumeClassBodyDeclaration();  
				break;
	 
	    case 215 : if (DEBUG) { System.out.println("Diet ::="); }  //$NON-NLS-1$
			    consumeDiet();  
				break;

	    case 216 : if (DEBUG) { System.out.println("Initializer ::= Diet NestedMethod CreateInitializer Block"); }  //$NON-NLS-1$
			    consumeClassBodyDeclaration();  
				break;
	 
	    case 217 : if (DEBUG) { System.out.println("CreateInitializer ::="); }  //$NON-NLS-1$
			    consumeCreateInitializer();  
				break;

	    case 219 : if (DEBUG) { System.out.println("PropertyDeclaration ::= Modifiersopt Type Identifier..."); }  //$NON-NLS-1$
			    consumePropertyDeclaration();  
				break;

	    case 220 : if (DEBUG) { System.out.println("PropertyHeader ::="); }  //$NON-NLS-1$
			    consumePropertyHeader();  
				break;

	    case 221 : if (DEBUG) { System.out.println("AccessorDeclaration ::="); }  //$NON-NLS-1$
			    consumeEmptyAccessor();  
				break;

	    case 225 : if (DEBUG) { System.out.println("SetAccessorDeclarationopt ::= SetAccessorDeclaration"); }  //$NON-NLS-1$
			    consumeAccessoropt();  
				break;

	    case 226 : if (DEBUG) { System.out.println("SetAccessorDeclaration ::= SetterMethodHeader MethodBody"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(true, false);   
				break;

	    case 227 : if (DEBUG) { System.out.println("SetAccessorDeclaration ::= SetterMethodHeader SEMICOLON"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(false, false);   
				break;

	    case 228 : if (DEBUG) { System.out.println("SetterMethodHeader ::= PLUS"); }  //$NON-NLS-1$
			    consumeAccessorMethodName(MethodDeclaration.SETTER);  
				break;

	    case 230 : if (DEBUG) { System.out.println("GetAccessorDeclarationopt ::= GetAccessorDeclaration"); }  //$NON-NLS-1$
			    consumeAccessoropt();  
				break;

	    case 231 : if (DEBUG) { System.out.println("GetAccessorDeclaration ::= GetterMethodHeader MethodBody"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(true, false);   
				break;

	    case 232 : if (DEBUG) { System.out.println("GetAccessorDeclaration ::= GetterMethodHeader SEMICOLON"); }  //$NON-NLS-1$
			     consumeMethodDeclaration(false, false);   
				break;

	    case 233 : if (DEBUG) { System.out.println("GetterMethodHeader ::= AND"); }  //$NON-NLS-1$
	    ...
	    case 236 : if (DEBUG) { System.out.println("IndexerDeclaration ::= IndexerHeader FormalParameter..."); }  //$NON-NLS-1$
			    consumeIndexerDeclarationNoAccessor();  
				break;

	    case 237 : if (DEBUG) { System.out.println("IndexerHeader ::= Modifiersopt Type this LBRACKET"); }  //$NON-NLS-1$
	 ...
	 consumeMethodDeclaration(false, false);  
	    ...
	    case 264 : if (DEBUG) { System.out.println("AbstractMethodDeclaration ::= MethodHeader CODE_DATA..."); }  //$NON-NLS-1$
			    // set to false to consume a method without body
	 consumeMethodDeclarationWithCode(false, false);  
	    ...
	    case 281 : if (DEBUG) { System.out.println("CatchFormalParameter ::= Modifiersopt CatchType..."); }  //$NON-NLS-1$
			    consumeCatchFormalParameter();  
				break;
	 
	    case 282 : if (DEBUG) { System.out.println("CatchType ::= UnionType"); }  //$NON-NLS-1$
			    consumeCatchType();  
				break;
	 
	    case 283 : if (DEBUG) { System.out.println("UnionType ::= Type"); }  //$NON-NLS-1$
			    consumeUnionTypeAsClassType();  
				break;
	 
	    case 284 : if (DEBUG) { System.out.println("UnionType ::= UnionType OR Type"); }  //$NON-NLS-1$
			    consumeUnionType();  
				break;
	 
	    case 286 : if (DEBUG) { System.out.println("ClassTypeList ::= ClassTypeList COMMA ClassTypeElt"); }  //$NON-NLS-1$
			    consumeClassTypeList();  
				break;
	 
	    case 287 : if (DEBUG) { System.out.println("ClassTypeElt ::= ClassType"); }  //$NON-NLS-1$
			    consumeClassTypeElt();  
				break;
	 
	    case 288 : if (DEBUG) { System.out.println("MethodBody ::= NestedMethod LBRACE BlockStatementsopt..."); }  //$NON-NLS-1$
			    consumeMethodBody();  
				break;
	 
	    case 289 : if (DEBUG) { System.out.println("NestedMethod ::="); }  //$NON-NLS-1$
			    consumeNestedMethod();  
				break;
	 
	    case 290 : if (DEBUG) { System.out.println("StaticInitializer ::= StaticOnly Block"); }  //$NON-NLS-1$
			    consumeStaticInitializer();  
				break;

	    case 291 : if (DEBUG) { System.out.println("StaticOnly ::= static"); }  //$NON-NLS-1$
			    consumeStaticOnly();  
				break;
	 
	    case 292 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader MethodBody"); }  //$NON-NLS-1$
			    consumeConstructorDeclaration() ;  
				break;
	 
	    case 293 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader SEMICOLON"); }  //$NON-NLS-1$
			    consumeInvalidConstructorDeclaration() ;  
				break;
	 
	    case 294 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader CODE_DATA..."); }  //$NON-NLS-1$
	    ...
	    case 296 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= this OnlyTypeArguments"); }  //$NON-NLS-1$
	    ...
	    case 298 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= super OnlyTypeArguments"); }  //$NON-NLS-1$
	    ...
	    case 302 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT super..."); }  //$NON-NLS-1$
			    consumeExplicitConstructorInvocationWithTypeArguments(2, SUPER_CALL);  
				break;
	 
	    case 303 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Primary DOT this LPAREN"); }  //$NON-NLS-1$
	    ...
	    case 306 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT this..."); }  //$NON-NLS-1$
	    ...
	    case 335 : if (DEBUG) { System.out.println("PushLeftBrace ::="); }  //$NON-NLS-1$
			    consumePushLeftBrace();  
				break;
	 
	    case 336 : if (DEBUG) { System.out.println("ArrayInitializer ::= LBRACE PushLeftBrace ,opt RBRACE"); }  //$NON-NLS-1$
	    ...
	    case 340 : if (DEBUG) { System.out.println("VariableInitializers ::= VariableInitializers COMMA..."); }  //$NON-NLS-1$
			    consumeVariableInitializers();  
				break;
	 
	    case 341 : if (DEBUG) { System.out.println("Block ::= OpenBlock LBRACE BlockStatementsopt RBRACE"); }  //$NON-NLS-1$
			    consumeBlock();  
				break;
	 
	    case 342 : if (DEBUG) { System.out.println("OpenBlock ::="); }  //$NON-NLS-1$
			    consumeOpenBlock() ;  
				break;
	 
	    case 343 : if (DEBUG) { System.out.println("BlockStatements ::= BlockStatement"); }  //$NON-NLS-1$
			    consumeBlockStatement() ;  
				break;
	 
	    case 344 : if (DEBUG) { System.out.println("BlockStatements ::= BlockStatements BlockStatement"); }  //$NON-NLS-1$
	    ...
	    case 430 : if (DEBUG) { System.out.println("ExitTryBlock ::="); }  //$NON-NLS-1$
			    consumeExitTryBlock();  
				break;
	 
	    case 432 : if (DEBUG) { System.out.println("Catches ::= Catches CatchClause"); }  //$NON-NLS-1$
			    consumeCatches();  
				break;
	 
	    case 433 : if (DEBUG) { System.out.println("CatchClause ::= catch LPAREN CatchFormalParameter RPAREN"); }  //$NON-NLS-1$
			    consumeStatementCatch() ;  
				break;
	 
	    case 435 : if (DEBUG) { System.out.println("PushLPAREN ::= LPAREN"); }  //$NON-NLS-1$
			    consumeLeftParen();  
				break;
	 
	    case 436 : if (DEBUG) { System.out.println("PushRPAREN ::= RPAREN"); }  //$NON-NLS-1$
			    consumeRightParen();  
				break;
	 
	    case 441 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= this"); }  //$NON-NLS-1$
			    consumePrimaryNoNewArrayThis();  
				break;
	 
	    case 442 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PushLPAREN Expression_NotName..."); }  //$NON-NLS-1$
			    consumePrimaryNoNewArray();  
				break;
	 
	    case 443 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PushLPAREN Name PushRPAREN"); }  //$NON-NLS-1$
			    consumePrimaryNoNewArrayWithName();  
				break;
	 
	    case 446 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name DOT this"); }  //$NON-NLS-1$
			    consumePrimaryNoNewArrayNameThis();  
				break;
	 
	    case 447 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name DOT super"); }  //$NON-NLS-1$
			    consumePrimaryNoNewArrayNameSuper();  
				break;
	 
	    case 448 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name DOT class"); }  //$NON-NLS-1$
			    consumePrimaryNoNewArrayName();  
				break;
	 
	    case 449 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name Dims DOT class"); }  //$NON-NLS-1$
			    consumePrimaryNoNewArrayArrayType();  
				break;
	 
	    case 450 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PrimitiveType Dims DOT class"); }  //$NON-NLS-1$
			    consumePrimaryNoNewArrayPrimitiveArrayType();  
				break;
	 
	    case 451 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PrimitiveType DOT class"); }  //$NON-NLS-1$
	    ...
	    case 481 : if (DEBUG) { System.out.println("AllocationHeader ::= new ClassType LPAREN ArgumentListopt"); }  //$NON-NLS-1$
			    consumeAllocationHeader();  
				break;
	 
	    case 482 : if (DEBUG) { System.out.println("ClassInstanceCreationExpression ::= new OnlyTypeArguments"); }  //$NON-NLS-1$
	    ...
	    case 517 : if (DEBUG) { System.out.println("MethodInvocation ::= MethodInvocation LPAREN..."); }  //$NON-NLS-1$
			    consumeMethodInvocationInvocation();  
				break;
	 
	    case 518 : if (DEBUG) { System.out.println("MethodInvocation ::= ArrayAccess LPAREN ArgumentListopt"); }  //$NON-NLS-1$
			    consumeMethodInvocationArraySccess();  
				break;
	 
	    case 519 : if (DEBUG) { System.out.println("MethodInvocation ::= LambdaExpression LPAREN..."); }  //$NON-NLS-1$
	    ...
	    case 525 : if (DEBUG) { System.out.println("ArrayAccess ::= super LBRACKET Expression RBRACKET"); }  //$NON-NLS-1$
			    consumeArrayAccess(true);  
				break;
	 
	    case 526 : if (DEBUG) { System.out.println("ArrayAccess ::= PrimaryNoNewArray LBRACKET Expression..."); }  //$NON-NLS-1$
			    consumeArrayAccess(false);  
				break;
	 
	    case 527 : if (DEBUG) { System.out.println("ArrayAccess ::= ArrayCreationWithArrayInitializer..."); }  //$NON-NLS-1$
			    consumeArrayAccess(false);  
				break;
	 
	    case 529 : if (DEBUG) { System.out.println("PostfixExpression ::= Name"); }  //$NON-NLS-1$
			    consumePostfixExpression();  
				break;
	 
	    case 532 : if (DEBUG) { System.out.println("PostIncrementExpression ::= PostfixExpression PLUS_PLUS"); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.PLUS,true);  
				break;
	 
	    case 533 : if (DEBUG) { System.out.println("PostDecrementExpression ::= PostfixExpression MINUS_MINUS"); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.MINUS,true);  
				break;
	 
	    case 534 : if (DEBUG) { System.out.println("PushPosition ::="); }  //$NON-NLS-1$
			    consumePushPosition();  
				break;
	 
	    case 537 : if (DEBUG) { System.out.println("UnaryExpression ::= PLUS PushPosition UnaryExpression"); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.PLUS);  
				break;
	 
	    case 538 : if (DEBUG) { System.out.println("UnaryExpression ::= MINUS PushPosition UnaryExpression"); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.MINUS);  
				break;
	 
	    case 540 : if (DEBUG) { System.out.println("PreIncrementExpression ::= PLUS_PLUS PushPosition..."); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.PLUS,false);  
				break;
	 
	    case 541 : if (DEBUG) { System.out.println("PreDecrementExpression ::= MINUS_MINUS PushPosition..."); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.MINUS,false);  
				break;
	 
	    case 543 : if (DEBUG) { System.out.println("UnaryExpressionNotPlusMinus ::= TWIDDLE PushPosition..."); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.TWIDDLE);  
				break;
	 
	    case 544 : if (DEBUG) { System.out.println("UnaryExpressionNotPlusMinus ::= NOT PushPosition..."); }  //$NON-NLS-1$
			    consumeUnaryExpression(OperatorIds.NOT);  
				break;
	 
	    case 546 : if (DEBUG) { System.out.println("CastExpression ::= PushLPAREN PrimitiveType Dimsopt..."); }  //$NON-NLS-1$
	    ...
	    case 548 : if (DEBUG) { System.out.println("CastExpression ::= PushLPAREN Name..."); }  //$NON-NLS-1$
			    consumeCastExpressionWithQualifiedGenericsArray();  
				break;
	 
	    case 549 : if (DEBUG) { System.out.println("CastExpression ::= PushLPAREN Name PushRPAREN..."); }  //$NON-NLS-1$
			    consumeCastExpressionLL1();  
				break;
	 
	    case 550 : if (DEBUG) { System.out.println("CastExpression ::= BeginIntersectionCast PushLPAREN..."); }  //$NON-NLS-1$
			    consumeCastExpressionLL1WithBounds();  
				break;
	 
	    case 551 : if (DEBUG) { System.out.println("CastExpression ::= PushLPAREN Name Dims..."); }  //$NON-NLS-1$
			    consumeCastExpressionWithNameArray();  
				break;
	 
	    case 552 : if (DEBUG) { System.out.println("AdditionalBoundsListOpt ::="); }  //$NON-NLS-1$
	    ...
	    case 559 : if (DEBUG) { System.out.println("InsideCastExpressionLL1WithBounds ::="); }  //$NON-NLS-1$
	    ...
	    case 581 : if (DEBUG) { System.out.println("EqualityExpression ::= EqualityExpression..."); }  //$NON-NLS-1$
			    consumeEqualityExpression(OperatorIds.EQUAL_EQUAL_EQUAL);  
				break;
	 
	    case 582 : if (DEBUG) { System.out.println("EqualityExpression ::= EqualityExpression NOT_EQUAL_EQUAL"); }  //$NON-NLS-1$
	    ...
	    case 593 : if (DEBUG) { System.out.println("ConditionalOrExpression ::= ConditionalOrExpression OR_OR"); }  //$NON-NLS-1$
	    ...
	    case 621 : if (DEBUG) { System.out.println("ClassBodyDeclarationsopt ::="); }  //$NON-NLS-1$
			    consumeEmptyClassBodyDeclarationsopt();  
				break;
	 
	    case 622 : if (DEBUG) { System.out.println("ClassBodyDeclarationsopt ::= NestedType HtmlSection"); }  //$NON-NLS-1$
			    consumeObjectElementClassBodyDeclarationsopt();  
				break;
	 
	    case 623 : if (DEBUG) { System.out.println("ClassBodyDeclarationsopt ::= NestedType..."); }  //$NON-NLS-1$
			    consumeClassBodyDeclarationsopt();  
				break;
	 
	    case 624 : if (DEBUG) { System.out.println("ClassBodyDeclarationsopt ::= NestedType HtmlSection..."); }  //$NON-NLS-1$
	    ...
	    case 641 : if (DEBUG) { System.out.println("NestedType ::="); }  //$NON-NLS-1$
	     ...
	     case 655 : if (DEBUG) { System.out.println("EnumBody ::= LBRACE COMMA EnumBodyDeclarationsopt RBRACE"); }  //$NON-NLS-1$
			    consumeEnumBodyNoConstants();  
				break;
	    ...
	    case 661 : if (DEBUG) { System.out.println("EnumConstantHeader ::= EnumConstantHeaderName ForceNoDiet"); }  //$NON-NLS-1$
			    consumeEnumConstantHeader();  
				break;
	 
	    case 662 : if (DEBUG) { System.out.println("EnumConstant ::= EnumConstantHeader ForceNoDiet ClassBody"); }  //$NON-NLS-1$
	    ...
	    case 707 : if (DEBUG) { System.out.println("Wildcard1 ::= TypeAnnotationsopt QUESTION WildcardBounds1"); }  //$NON-NLS-1$
	    ...
	    case 711 : if (DEBUG) { System.out.println("Wildcard2 ::= TypeAnnotationsopt QUESTION WildcardBounds2"); }  //$NON-NLS-1$
	    ...
	    case 715 : if (DEBUG) { System.out.println("Wildcard3 ::= TypeAnnotationsopt QUESTION WildcardBounds3"); }  //$NON-NLS-1$
	    ...
	    case 756 : if (DEBUG) { System.out.println("AdditiveExpression_NotName ::= AdditiveExpression_NotName"); }  //$NON-NLS-1$
			    consumeBinaryExpression(OperatorIds.PLUS);  
				break;
	    ...
	    case 780 : if (DEBUG) { System.out.println("EqualityExpression_NotName ::= EqualityExpression_NotName"); }  //$NON-NLS-1$
			    consumeEqualityExpression(OperatorIds.EQUAL_EQUAL);  
				break;
