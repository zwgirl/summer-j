...
import org.summer.sdt.internal.compiler.codegen.StackMapFrame;
import org.summer.sdt.internal.compiler.codegen.StackMapFrameCodeStream;
import org.summer.sdt.internal.compiler.codegen.StackMapFrameCodeStream.ExceptionMarker;
import org.summer.sdt.internal.compiler.codegen.StackMapFrameCodeStream.StackDepthMarker;
import org.summer.sdt.internal.compiler.codegen.StackMapFrameCodeStream.StackMarker;
import org.summer.sdt.internal.compiler.codegen.TypeAnnotationCodeStream;
import org.summer.sdt.internal.compiler.codegen.VerificationTypeInfo;
...
//		this.contents[this.contentsOffset++] = (byte) descriptorIndex;
		...
		int descriptorIndex = this.constantPool.literalIndex(fieldBinding.signature(this));
		this.contents[this.contentsOffset++] = (byte) (descriptorIndex >> 8);
		this.contents[this.contentsOffset++] = (byte) descriptorIndex;
		//cym 2015-02-12
