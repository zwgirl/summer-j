...
public class JavaFile {
	...
	public JavaFile(char[][] compoundName){
		content = new StringBuffer();
		this.compoundName = compoundName;
	}

	public static JavaFile getNewInstance(char[][] compoundName) {
		return new JavaFile(compoundName);
	}
	...
	public static void createProblemType(TypeDeclaration typeDeclaration, CompilationResult unitResult) {
		...
		JavaFile classFile = JavaFile.getNewInstance(typeDeclaration.binding.compoundName);
