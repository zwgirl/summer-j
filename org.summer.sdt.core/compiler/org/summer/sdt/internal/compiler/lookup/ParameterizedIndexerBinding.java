...
/**
 * 
 * @author cym 2014-11-04
 *
 */
public class ParameterizedIndexerBinding extends IndexerBinding {

    public IndexerBinding originalField;

	public ParameterizedIndexerBinding(ParameterizedTypeBinding parameterizedDeclaringClass, IndexerBinding originalField) {
	    super (
	            originalField.name,
