...
//		
//		int argc = this.descriptor.parameterTypes().length;
//		
...
//        											       scope.getConstructor((ReferenceBinding) this.receiverType, descriptorParameters, this);
        MethodBinding someMethod = isMethodReference ? scope.getMethod1(this.receiverType, this.selector, descriptorParameters, this) :
		       scope.getConstructor((ReferenceBinding) this.receiverType, descriptorParameters, this);
        //cym 2015-03-23 end
...
//		} 
	...
	public boolean isPotentiallyCompatibleWith(TypeBinding targetType, Scope scope) {
        ...
        try {
        	...
        	/* 15.12.2.1: A method reference expression (搂15.13) is potentially compatible with a functional interface type if, where the type's function type arity is n, 
		       there exists at least one potentially applicable method for the method reference expression with arity n (搂15.13.1), and one of the following is true:
                   鈥�The method reference expression has the form ReferenceType ::[TypeArguments] Identifier and at least one potentially applicable method is
                        i) static and supports arity n, or ii) not static and supports arity n-1.
                   鈥�The method reference expression has some other form and at least one potentially applicable method is not static.
        	*/
	...
	public org.summer.sdt.internal.compiler.lookup.MethodBinding getMethodBinding() {
